...
if (isset($_POST["tipo2"])) {
    ...
    if($tipo2=="editar_contacto"){
        ...
        $re = $client->updateContacto($nombres,$celular,$telefono,$direccion, $correo,$pagina,$facebook,$instagram,$twitter,$_SESSION["usuario"]);
        $resultado = "".$re;
...
if($resultado=="true"){
    ...
    if($tipo=="editar"){
        ...
        <script type="text/javascript"> 
            var n = noty({
            text        : '<div class="alert alert-success "><p><strong>Se creo correctamente</p></div>',
            layout      : 'topCenter', //or left, right, bottom-right...
            theme       : 'made',
            type        : 'error',
            maxVisible  : 5,
