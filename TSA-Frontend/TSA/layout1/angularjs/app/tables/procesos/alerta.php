...
if($resultado=="true"){
    if(isset($_POST["promo"])){
        ...
        if ( isset($_POST["editar"])){
            ...
            <script type="text/javascript"> 
                var n = noty({
                text        : '<div class="alert alert-success "><p><strong>Se edito la promoción correctamente</p></div>',
        ...
        if (isset($_POST["localidadG"])) {
            if ( isset($_POST["editar"])){
                ...
                <script type="text/javascript"> 
                   var n = noty({
                    text        : '<div class="alert alert-success "><p><strong>Se creo la promoción correctamente</p></div>',
                    layout      : 'topCenter', //or left, right, bottom-right...
                    theme       : 'made',
                    type        : 'error',
                    maxVisible  : 5,
        ...
        if (isset($_POST["id"])) {
            ...
            if($tipoR=="B"){
                ...
                <script type="text/javascript"> 
                    var n = noty({
                        text        : '<div class="alert alert-success "><p><strong>Se creo cortesia correctamente</p></div>',
                        layout      : 'topCenter', //or left, right, bottom-right...
                        theme       : 'made',
                        type        : 'error',
                        maxVisible  : 5,
