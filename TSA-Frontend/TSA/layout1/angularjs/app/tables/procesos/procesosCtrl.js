  ...
  .controller('procesosCtrl', ['$scope','pluginsService', function ($scope ,pluginsService) {
      ...
      $scope.$on('$viewContentLoaded', function () {
        ...
        $(document).on('click', '.editar_contacto', function (e) {
            ...
            if(band){
                $('#alerta').load('./tables/procesos/alerta2.php', {tipo:"editar",tipo2:"editar_contacto",nombres:nombres,celular:celular,telefono:telefono,correo:correo,pagina:pagina,facebook:facebook,instagram:instagram,direccion:direccion,direccion:direccion,twitter:twitter},function() {    
                    $('.page-spinner-loader').addClass('hide');
                });
            }else{
                $('.page-spinner-loader').addClass('hide');
