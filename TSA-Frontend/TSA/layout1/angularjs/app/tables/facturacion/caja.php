        ...
        <div class="col-lg-12 portlets">
            <div class="panel">
                ...
                <div class="panel-content pagination2 table-responsive">
                    ...
                    <table class="table caja_data table-dynamic1 table-caja " data-table-name="Cajas" id="table-cajas" style="table-layout: fixed;">
                        <thead>
                        <tr>
                                <th>Id</th>
                                <th>Nombres</th>
            ...
            <div class="panel">
                <div class="panel-content pagination2 ">
                    ...
                    <div class="modal-footer text-center">
                        <button type="button"  class="btn btn-embossed btn-default cancelarP " data-dismiss="modal" aria-hidden="true">Cancelar</button>
                    </div> 
                </div> 
            </div>
        </div>
        ...
        <div class="col-lg-12 portlets">
            <div class="panel">
                ...
                <div class="panel-content pagination2 table-responsive">
                    ...
                    <table class="table filter-footer clientes_data table-dynamic table-tools1 " data-table-name="Usuarios" id="table-editable" style="table-layout: fixed;">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Nombres</th>
