                    ...
                    <ul class="nav nav-sidebar">
                        ...
                        <li class="nav-parent">
                            ...
                            <ul class="children collapse">
                                ...
                                <li class="<?php echo $TprocesosPromocionG; ?> " ng-class="{ active  : isActive('/amigos')}"><a href="#amigos"> Amigos del Teatro</a></li>
                                <li class="<?php echo $TprocesosPromocionG; ?> " ng-class="{ active  : isActive('/contactos')}"><a href="#contactos"> Contactos</a></li>
                                <li class="<?php echo $TprocesosPromocionG; ?> " ng-class="{ active  : isActive('/fundacion')}"><a href="#fundacion"> Fundación</a></li>
                            </ul>
                        </li>
                        <?php } ?>
                        <?php if($modulo5){ ?>
