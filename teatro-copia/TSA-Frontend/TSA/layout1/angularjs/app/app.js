...
var MakeApp = angular
  ...
  .config(function ($routeProvider) {
      $routeProvider
        ...
        .when('/evento-venta-editar', {
      //      templateUrl: 'tables/evento/evento-venta-editar.php',
        ...
        .when('/evento-gratuito-editar', {
            templateUrl: 'tables/evento/evento-gratuito-editar.php',
            controller: 'editarEvento_informativo_Ctrl'
        })
        .when('/evento-informativo', {
            templateUrl: 'tables/evento/evento-informativo.php',
            controller: 'eventoCtrl'
        })
        .when('/evento-informativo-editar', {
            templateUrl: 'tables/evento/evento-informativo-editar.php',
            controller: 'editarEvento_informativo_Ctrl'
        })
        .when('/crear_venta', {
            templateUrl: 'tables/evento/crear_venta.php',
            controller: 'eventoCtrl'
        })
         //Procesos
         .when('/distribucion', {
        ...
        .when('/promociones', {
            templateUrl: 'tables/procesos/promociones.php',
            controller: 'promocionesCtrl'
        })
        .when('/promocion-editar', {
            templateUrl: 'tables/procesos/promociones-editar.php',
            controller: 'promociones_editar_Ctrl'
        })
        .when('/promocion-agregar', {
            templateUrl: 'tables/procesos/promociones-agregar.php',
            controller: 'promociones_editar_Ctrl'
        })
        ...
        .when('/reportes-facturacion', {
            templateUrl: 'tables/facturacion/reportes-facturacion.php',
            controller: 'facturacionCtrl'
        })
