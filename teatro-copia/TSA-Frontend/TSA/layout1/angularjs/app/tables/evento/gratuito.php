                    ...
                    <div class="m-b-20">
                        <div class="btn-group">
                            <div data-toggle="modal" data-target="#modal-responsive">
                                <button class="btn btn-sm btn-dark"><i class="fa fa-plus"></i> Agregar Eventos Gratuitos</button>
                            </div>
                            
                        </div>
                    </div>
                    <table class="table filter-footer table-dynamic table-tools2  " data-table-name="Eventos Gratuitos" id="table-editable"  style="table-layout: fixed;">
                    <thead>
                            <tr>
                                <th>Id</th>
                                <th>Nombres</th>
                        ...
                        <tbody>
                            ...
                            <th>Id</th>
                                ...
                                <td class="text-right">
                                    <a class="editar btn btn-sm btn-dark" style="margin: 5px;"  href="#evento-gratuito-editar"><i class="icon-note"></i></a>
        ...
        <div class="modal-dialog modal-lg ">
            <div class="modal-content  ">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Crear <strong>Eventos Gratuitos</strong> </h4>
                </div>
