        ...
        <div class="col-lg-12 portlets">
            <div class="panel">
                ...
                <div class="panel-content pagination2 table-responsive">
                    ...
                    <table class="table filter-footer table-dynamic table-tools2  " data-table-name="Eventos Informativo" id="table-editable" style="table-layout: fixed;">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Nombres</th>
                                ...
                                <th>Fecha Final</th>
                                <th>Sala</th> 
                                <th class="esconder">Tickets Registrados</th>
                                <th>Estado</th>    
                        ...
                        <?php
                           ...
                           <tr>
                                ...
                                <td class="esconder"> <?php if (isset($usuario[14])) {echo $usuario[14]; }  ?> </td>
                                <th>
                                    <?php 
                                        if ($usuario[16]==="A" ) {
                                            $estado="checked";
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th>Fecha Final</th>
                                <th>Sala</th>  
                                <th class="esconder">Tickets Vendidos</th>
                                <th>Estado</th>     
                            </tr>
                        </tfoot>
                    </table>
