...
class MainController extends BaseController
{
    ...
    public function getContacto($request, $response, $args){
        ...
        while($item = $statement->fetch()){
          ...
          'facebook'=> $item->facebook, 'instagram'=> $item->instagram, 'twitter'=> $item->twitter, 'logo_light'=>$ruta."\\images\\logo\\".$item->logo_light, 'logo_dark'=> $ruta."\\images\\logo\\".$item->logo_dark);
        }
       if ($band) {
         $out["codigo"] = "208";
