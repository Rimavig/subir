      ...
      public function createCorp($request, $response, $args){
        ...
        public function insertEsperaP($request, $response, $args){
          ...
          try {
            ...
            foreach($asientos as $llave => $valores) {
              $sql = "INSERT INTO tsa_bloqueo_asiento (id_usuario_cliente,id_distribucion) VALUES (:id_usuario,:asiento)";
              $statement = $db->prepare($sql);
              $statement->bindValue(':id_usuario', $usuario, \PDO::PARAM_STR);
              $statement->bindValue(':asiento', $valores, \PDO::PARAM_STR);
              $result = $statement->execute();
        ...
        public function updateEsperaP($request, $response, $args){
          ...
          try {
            ...
            foreach($asientos as $llave => $valores) {
              $sql = "UPDATE tsa_bloqueo_asiento set fecha_creacion =now() WHERE id_usuario_cliente=:id_usuario and id_distribucion=:asiento";
              $statement = $db->prepare($sql);
              $statement->bindValue(':id_usuario', $usuario, \PDO::PARAM_STR);
              $statement->bindValue(':asiento', $valores, \PDO::PARAM_STR);
              $result = $statement->execute();
        ...
        public function insertEsperaS($request, $response, $args){
          ...
          try {
            ...
            foreach($asientos as $llave => $valores) {
              ...
              $sql = "INSERT INTO tsa_bloqueo_cantidad (id_usuario_cliente,id_platea_funcion,cantidad) VALUES (:id_usuario,:id_platea_funcion, :cantidad)";
              $statement = $db->prepare($sql);
              $statement->bindValue(':id_usuario', $usuario, \PDO::PARAM_STR);
        ...
        public function updateEsperaS($request, $response, $args){
          ...
          try {
            ...
            foreach($asientos as $llave => $valores) {
              ...
              $sql = "UPDATE tsa_bloqueo_cantidad set fecha_creacion =now() WHERE id_usuario_cliente=:id_usuario and id_platea_funcion=:id_platea_funcion and cantidad=:cantidad";
              $statement = $db->prepare($sql);
              $statement->bindValue(':id_usuario', $usuario, \PDO::PARAM_STR);
              $statement->bindValue(':id_platea_funcion', $id_platea_funcion, \PDO::PARAM_STR);
              $statement->bindValue(':cantidad',   $cantidad, \PDO::PARAM_STR);
        ...
        public function deleteEsperaS($request, $response, $args){
          ...
          try {
            ...
            foreach($asientos as $llave => $valores) {
              ...
              $sql = "DELETE FROM tsa_bloqueo_cantidad WHERE id_usuario_cliente=:id_usuario and id_platea_funcion=:id_platea_funcion and cantidad=:cantidad";
              $statement = $db->prepare($sql);
              $statement->bindValue(':id_usuario', $usuario, \PDO::PARAM_STR);
              $statement->bindValue(':id_platea_funcion', $id_platea_funcion, \PDO::PARAM_STR);
              $statement->bindValue(':cantidad',   $cantidad, \PDO::PARAM_STR);
        ...
        public function updateFacturacion($request, $response, $args){
          ...
          $tipo = trim($body['tipo']);
          try {
            $sql = "UPDATE tsa_facturacion SET nombres=:nombres, apellidos=:apellidos, razon_social=:razon_social, cedula=:cedula, ruc=:ruc, tipo=:tipo, correo=:correo, direccion=:direccion WHERE id_facturacion=:id_facturacion";
            $statement = $db->prepare($sql);
        ...
        public function insertFacturacion($request, $response, $args){
          ...
          $ruc = trim($body['ruc']);
          $tipo = trim($body['tipo']);
          $sql = "INSERT INTO tsa_facturacion (id_usuario_cliente,nombres,apellidos,cedula,razon_social,ruc,tipo,direccion,correo,usuario_creacion)
        ...
        public function setFacturacion_favorita($request, $response, $args){
          ...
          try {
            ...
            while($item = $statement->fetch()){
              $band=false;
              $sql = " UPDATE tsa_facturacion_favorita SET id_facturacion=:id_facturacion WHERE id_facturacion_favorita=$item->id_facturacion_favorita";
              $statement1 = $db->prepare($sql);
            ...
            if($band){
              $sql = "INSERT INTO tsa_facturacion_favorita (id_usuario_cliente,id_facturacion,usuario_creacion) VALUES (:id_usuario,:id_facturacion,'usuario')";
              $statement = $db->prepare($sql);
              $statement->bindValue(':id_facturacion', $id_facturacion, \PDO::PARAM_STR);
              $statement->bindValue(':id_usuario', $id_usuario, \PDO::PARAM_STR);
              $result = $statement->execute();
        ...
        public function setTarjeta_favorita($request, $response, $args){
          ...
          try {
            ...
            while($item = $statement->fetch()){
              $band=false;
              $sql = "UPDATE tsa_tarjeta_favorita SET bin=:bin1 , `status`=:status1, token=:token, holder_name=:holder_name, expiry_year=:expiry_year, expiry_month=:expiry_month, transaction_reference=:transaction_reference, `type`=:type1, `number`=:number1  WHERE id_tarjeta_favorita=$item->id_tarjeta_favorita";
              $statement1 = $db->prepare($sql);
            ...
            if($band){
              $sql = "INSERT INTO tsa_tarjeta_favorita (id_usuario_cliente,bin,`status`,token,holder_name,expiry_year,expiry_month,transaction_reference,`type`,`number`,usuario_creacion)
        ...
        public function getTokenFCM($request, $response, $args){
          ...
          while($item = $statement->fetch()){
            $band=false;
            $facturacion=  array('id_usuario'=> $item->id_usuario_cliente, 'tokenFCM'=> $item->tokenFCM,);
          }
          $response->getBody()->write(json_encode($facturacion));
          return $response;
        }

        public function updateTokenFCM($request, $response, $args){
          include("error.php");
          $response = $response->withHeader('Content-Type', 'application/json');
          $corpName = $request->getAttribute('corpName');
          $db = $this->container->get('db');
          ...
          $json = $request->getBody();
          $body = json_decode($json, true);
          if (!(isset($body["id_usuario"])  && isset($body["tokenFCM"]))){
            $out["codigo"] = "201";
            $out["mensaje"] = $error_201_mensaje;
            $out["causa"] =  $error_201_causa;
            $response->getBody()->write(json_encode($out));
          ...
          $id_usuario = trim($body['id_usuario']);
          $tokenFCM = trim($body['tokenFCM']);

          try {
            $sql = "UPDATE tsa_usuario_cliente SET tokenFCM=:tokenFCM WHERE id_usuario_cliente=:id_usuario";
            $statement = $db->prepare($sql);
            $statement->bindValue(':id_usuario', $id_usuario, \PDO::PARAM_STR);
            $statement->bindValue(':tokenFCM', $tokenFCM, \PDO::PARAM_STR);
        ...
        public function getTickets($request, $response, $args){
          ...
          try {
            $sql = "SELECT tp.nombre as platea, te.*, tt.precio , tt.descuento,tt.sala, tf.fecha, tt.id_ticket, tta.asiento,tt.estado as estado_ticket FROM tsa_ticket tt
            ...
            while($item = $statement->fetch()){
              if (!in_array($item->id_ticket, $tickets)) {
                ...
                $valP=($item->precio)-($item->descuento);
                ...
                'tipo'=> $item->tipo,'sala'=> $item->sala,'precio'=> (string)$valP,'fecha'=> $item->fecha,'estado'=> $item->estado_ticket,'qr'=>$auth_token1);
        ...
        public function callback($request, $response, $args){
          ...
          try {
            ...
            if ($band) {
              $sql = "INSERT INTO tsa_callback_paymentez (status,order_description,authorization_code,status_detail,`date`,message,id,dev_reference,carrier_code,amount,paid_date,installments,ltp_id,stoken,application_code,userid,useremail,bin,holder_name,`type`,`number`,origin)
              ...
              $sql = "UPDATE tsa_callback_paymentez SET status=:status,order_description=:order_description,authorization_code=:authorization_code,status_detail=:status_detail,
        ...
        public function insertRegistro_gratuito($request, $response, $args){
          ...
          try {
            ...
            $sql = "SELECT *  FROM tsa_funcion WHERE id_funcion=:id_funcion";
            $statement = $db->prepare($sql);
            $statement->bindValue(':id_funcion', $id_funcion, \PDO::PARAM_STR);
            $result = $statement->execute();
            ...
            while($item = $statement->fetch()){
              ...
              $aforoT =(int)$item->aforo;
              $aforoV =$item->cantidad_vendida;
              $aforoVC = $aforoV+$cantidad;
              if ($aforoT < $aforoVC) {
                $out["codigo"] = "221";
                $out["mensaje"] = "Oops! No tenemos más asientos disponibles para este evento.";
                $out["causa"] = $error_221_causa;
                $response->getBody()->write(json_encode($out));
                return $response->withStatus(400);
              }
            }
            $sql = "INSERT INTO tsa_registro_gratuito (nombres,apellidos,cedula,correo,celular,fecha_nacimiento,id_funcion,usuario_creacion,id_usuario_cliente,tipo,cantidad)
        ...
        public function insertPuntos($request, $response, $args){
          ...
          try {
            ...
            $sql = "UPDATE tsa_usuario_cliente SET puntos_acumulados=puntos_acumulados+:puntos WHERE id_usuario_cliente=:id_usuario_cliente";
            $statement = $db->prepare($sql);
            $statement->bindValue(':id_usuario_cliente', $id_usuario, \PDO::PARAM_STR);
            ...
            $puntos=0;
            $sql = "INSERT INTO tsa_amigos_puntos (id_usuario_cliente,id_compra,evento,cantidad,puntos,puntos_ganados,fecha_consumo) VALUES (:id_usuario_cliente,:id_compra,:evento,:cantidad,:puntos,:puntos_ganados,now());";
            $statement = $db->prepare($sql);
            $statement->bindValue(':id_usuario_cliente', $id_usuario, \PDO::PARAM_STR);
            $statement->bindValue(':id_compra', $id_compra, \PDO::PARAM_STR);
        ...
        public function compra_diners($request, $response, $args){
          ...
          try {
            if ($ban) {
              try {
                $sql = "INSERT INTO tsa_compra (id_facturacion,id_usuario_cliente,dolares_canjeados,donacion,sub_total,descuento,iva,total,usuario_creacion,id_transacion,authorization_code,status_transacion,tipo,email)
                VALUES (:id_facturacion,:id_usuario_cliente,:dolares_canjeados,:donacion,:sub_total,:descuento,:iva,:total,:usuario_creacion,:id_transacion,:authorization_code,:status_transacion,:tipo,:email)";
                $statement = $db->prepare($sql);
                $statement->bindValue(':id_facturacion', $id_facturacion, \PDO::PARAM_STR);
                $statement->bindValue(':id_usuario_cliente', $user_id, \PDO::PARAM_STR);
                ...
                if($valores!=""){
                  ...
                  try {
                    ...
                    if ($id_compra!=0) {
                      $puntos_canjeadosT=$totalP*$dolares_canjeados/$sub_total;
                      $puntos_canjeadosTK=number_format($puntos_canjeadosT, 2);
                      $sql = "INSERT INTO tsa_ticket (id_funcion,id_usuario_cliente,id_compra,sala,precio,tipo,usuario_creacion,descuento,puntos_canjeados)
                      VALUES (:id_funcion,:id_usuario_cliente,:id_compra,:sala,:precio,:tipo,:usuario_creacion,:descuento,:puntos_canjeados)";
                      $statement = $db->prepare($sql);
                      $statement->bindValue(':id_funcion', $id_funcion, \PDO::PARAM_STR);
                      $statement->bindValue(':id_usuario_cliente', $user_id, \PDO::PARAM_STR);
                      ...
                      if ($id_promocion!=0) {
                        if ($tipo_promocion=="FC" | $tipo_promocion=="CD" | $tipo_promocion=="FP" | $tipo_promocion=="BT" | $tipo_promocion=="CP") {
                          if ($tipo_promocion=="FC") {
                            $sql = "INSERT INTO tsa_ticket_promocion_factor_compra (id_promocion,id_ticket,descuento,id_usuario_cliente,usuario_creacion)
                            VALUES (:id_promocion,:id_ticket,:descuento,:id_usuario_cliente,:usuario_creacion)";
                            $statement = $db->prepare($sql);
                            $statement->bindValue(':id_promocion', $id_promocion, \PDO::PARAM_STR);
                            $statement->bindValue(':id_ticket', $id_ticket, \PDO::PARAM_STR);
                            ...
                            $sql = "INSERT INTO tsa_ticket_promocion_cruzados (id_promocion,id_ticket,descuento,id_usuario_cliente,usuario_creacion)
                            VALUES (:id_promocion,:id_ticket,:descuento,:id_usuario_cliente,:usuario_creacion)";
                            $statement = $db->prepare($sql);
                            $statement->bindValue(':id_promocion', $id_promocion, \PDO::PARAM_STR);
                            $statement->bindValue(':id_ticket', $id_ticket, \PDO::PARAM_STR);
                            ...
                            $sql = "INSERT INTO tsa_ticket_promocion_factor_pago (id_promocion,id_ticket,descuento,id_usuario_cliente,usuario_creacion)
                            VALUES (:id_promocion,:id_ticket,:descuento,:id_usuario_cliente,:usuario_creacion)";
                            $statement = $db->prepare($sql);
                            $statement->bindValue(':id_promocion', $id_promocion, \PDO::PARAM_STR);
                            $statement->bindValue(':id_ticket', $id_ticket, \PDO::PARAM_STR);
                            ...
                            $sql = "INSERT INTO tsa_ticket_promocion_tarjeta (id_promocion,id_ticket,descuento,id_usuario_cliente,usuario_creacion)
                            VALUES (:id_promocion,:id_ticket,:descuento,:id_usuario_cliente,:usuario_creacion)";
                            $statement = $db->prepare($sql);
                            $statement->bindValue(':id_promocion', $id_promocion, \PDO::PARAM_STR);
                            $statement->bindValue(':id_ticket', $id_ticket, \PDO::PARAM_STR);
                            ...
                            $sql = "INSERT INTO tsa_ticket_promocion_codigo (id_promocion,id_ticket,descuento,id_usuario_cliente,usuario_creacion)
                            VALUES (:id_promocion,:id_ticket,:descuento,:id_usuario_cliente,:usuario_creacion)";
                            $statement = $db->prepare($sql);
                            $statement->bindValue(':id_promocion', $id_promocion, \PDO::PARAM_STR);
                            $statement->bindValue(':id_ticket', $id_ticket, \PDO::PARAM_STR);
                    ...
                    $this->rembolso($id_transacion);
                    $sql = "DELETE FROM tsa_ticket_promocion_codigo WHERE id_ticket=:id_ticket";
                    $statement = $db->prepare($sql);
                    $statement->bindValue(':id_ticket', $id_ticket, \PDO::PARAM_STR);
                    $statement->execute();
                    $sql = "DELETE FROM tsa_ticket_promocion_cruzados WHERE id_ticket=:id_ticket";
                    $statement = $db->prepare($sql);
                    $statement->bindValue(':id_ticket', $id_ticket, \PDO::PARAM_STR);
                    $statement->execute();
                    $sql = "DELETE FROM tsa_ticket_promocion_factor_pago WHERE id_ticket=:id_ticket";
                    $statement = $db->prepare($sql);
                    $statement->bindValue(':id_ticket', $id_ticket, \PDO::PARAM_STR);
                    $statement->execute();
                    $sql = "DELETE FROM tsa_ticket_promocion_tarjeta WHERE id_ticket=:id_ticket";
                    $statement = $db->prepare($sql);
                    $statement->bindValue(':id_ticket', $id_ticket, \PDO::PARAM_STR);
                    $statement->execute();
                    $sql = "DELETE FROM tsa_ticket_promocion_factor_compra WHERE id_ticket=:id_ticket";
                    $statement = $db->prepare($sql);
                    $statement->bindValue(':id_ticket', $id_ticket, \PDO::PARAM_STR);
                    $statement->execute();
                    foreach($lista3 as $llave => $valo) {
                      $sql = "DELETE FROM tsa_ticket_asiento WHERE id_ticket=:id_ticket";
                      $statement = $db->prepare($sql);
                      $statement->bindValue(':id_ticket', $valo, \PDO::PARAM_STR);
                      $statement->execute();
                    }
                    $sql = "DELETE FROM tsa_ticket WHERE id_compra=:id_compra";
                    $statement = $db->prepare($sql);
                    $statement->bindValue(':id_compra', $id_compra, \PDO::PARAM_STR);
                    $statement->execute();
                    foreach($lista as $llave => $valo) {
                      if ($valo[0]=="1") {
                        $sql = "UPDATE tsa_platea_funcion SET vendido=vendido-:cantidad WHERE id_platea=:id_platea and id_funcion=:id_funcion;";
                        $statement = $db->prepare($sql);
                        $statement->bindValue(':cantidad', $valo[1], \PDO::PARAM_STR);
                        $statement->bindValue(':id_funcion', $valo[2], \PDO::PARAM_STR);
                        $statement->bindValue(':id_platea',$valo[3], \PDO::PARAM_STR);
                      ...
                      if ($valo[0]=="2") {
                        $sql = "UPDATE tsa_distribucion SET estado='E' WHERE id_distribucion=:id_distribucion";
                        $statement = $db->prepare($sql);
                        $statement->bindValue(':id_distribucion',  $valo[1], \PDO::PARAM_STR);
                        $statement->execute();
                      }
                    ...
                    $sql = "DELETE FROM tsa_compra WHERE id_compra=:id_compra";
                    $statement = $db->prepare($sql);
                    $statement->bindValue(':id_compra', $id_compra, \PDO::PARAM_STR);
                    $statement->execute();
                    $result = false;
                  ...
                  foreach($asientos as $llave => $valores1) {
                    ...
                    if ($tipo==1) {
                      ...
                      try {
                        if ($id_ticket!=0) {
                          $sql = "INSERT INTO tsa_ticket_asiento (id_ticket,asiento,precio,usuario_creacion,id_platea)
                          VALUES (:id_ticket,:asiento,:precio,:usuario_creacion,:id_platea)";
                          $statement = $db->prepare($sql);
                          $statement->bindValue(':id_ticket', $id_ticket, \PDO::PARAM_STR);
                          $statement->bindValue(':asiento', $cantidad, \PDO::PARAM_STR);
                      ...
                      try {
                        if ($id_ticket!=0) {
                          ...
                          $statement->bindValue(':usuario_creacion', $user_id, \PDO::PARAM_STR);
                          $statement->execute();
                          $sql = "UPDATE tsa_distribucion SET estado='V' WHERE id_distribucion=:id_distribucion";
                          $statement = $db->prepare($sql);
                          $statement->bindValue(':id_distribucion', $id_asiento, \PDO::PARAM_STR);
                          $statement->execute();
                          $lista[]= array("2", $id_asiento,$id_funcion,$id_platea);
        ...
        public function enviarContactanos($request, $response, $args){
          ...
          try {
            ...
            $sql = "INSERT INTO tsa_contactanos_web (nombre,correo,asunto,mensaje) VALUES (:nombres,:correo,:asunto,:mensaje)";
            $statement = $db->prepare($sql);
            $statement->bindValue(':nombres', $nombres, \PDO::PARAM_STR);
            $statement->bindValue(':correo', $correo, \PDO::PARAM_STR);
        ...
        public function enviarContactanosAlquiler($request, $response, $args){
          ...
          try {
            ...
            $total = trim($body['total']);
            $mensaje = trim($body['mensaje']);
            $sql = "INSERT INTO tsa_contactanos_alquiler (nombre,apellido,celular,tipo_evento,correo,fecha_inicio,fecha_termino,total_personas,mensaje)
            ...
            $client->sendMail1("11", "rvivanco@espol.edu.ec", "","", $id_envio."");
          } catch (\PDOException $th) {
            $result = false;
            $out["codigo"] = "102";
            $out["mensaje"] = $error_102_mensaje;
