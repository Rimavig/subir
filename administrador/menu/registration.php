...
<div class="prueba">
  ...
  <div class="container1">
      ...
      <label class="registro" for="cedula"><b>Cédula*</b></label>
      ...
      <div>
        <label class="registro" for="nacimiento"><b>Fecha de Nacimiento*</b></label>
        <input type="date" id="nacimiento" name="nacimiento" value="1970-04-01" min="1910-04-01" max="2020-04-30" title="Ingrese Fecha de nacimiento " required >
      </div>
      <div>
      <label class="registro" for="sexo"   ><b>Sexo*</b></label>
      ...
      <select name="ciudadela" title="Seleccione Ciudadela" id="ciudadel" >
        <?php
