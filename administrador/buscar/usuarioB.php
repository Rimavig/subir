  ...
  <div class="container1" id="container1" >
      <div class="menu_container">
          <label for="ciudadela" class="tableA"><b>Usuarios</b></label>
           <button  class="tableA " onclick="Busuarios()"  id="buscar"><span class="icon-users"></span>  Buscar</button>
      </div >
      ...
      <div class="cont3" >
        ...
        <div class="botonA" >
            <button class="tableB" onclick=" cargar('usuario')"  id="cargar"><span class="icon-users"></span>Aceptar</button>
        </div >
      </div >
  </div >
</span>
