...
<div class="usuarios table-responsive text-nowrap" >
  ...
  <div class="botonA" >
      <button class="tableB" onclick=" editar('0')"  id="editar"><span class="icon-users"></span>Editar</button>
      <button class="tableB" onclick=" eliminar('0')"  id="eliminar"><span class="icon-users"></span>Eliminar</button>
      <button class="tableB" onclick=" bloquear()" id="bloquear"><span class="icon-users"></span>Bloquear</button>
      <button class="tableB" onclick=" permisos()" id="permisos"><span class="icon-users"></span>Permisos</button>
  </div >
