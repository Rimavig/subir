...
<div class="usuarios table-responsive text-nowrap" >
  ...
  <div class="botonA" >
      <button class="tableB" onclick=" editar('1')"  id="editar"><span class="icon-users"></span>Editar</button>
      <button class="tableB" onclick=" eliminar('1')"  id="eliminar"><span class="icon-users"></span>Eliminar</button>
  </div >
