...
<div class="usuarios table-responsive text-nowrap" >
  ...
  <div class="botonA" >
      <button class="tableB" onclick=" editar()"  id="editar"><span class="icon-users"></span>Editar</button>
      <button class="tableB" onclick=" eliminar()"  id="eliminar"><span class="icon-users"></span>Eliminar</button>
