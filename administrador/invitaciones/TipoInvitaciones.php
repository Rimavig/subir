...
<span class="error">
    <div class="container1" >
        <div class=" conti1" >
          ...
          <div class="botonA" >
            <button  class="tableB " onclick="<?php echo $var2; ?>" ><span class="icon-users"></span>  Invitaciones<br>Normales</button>
            <button  class="tableB " onclick="<?php echo $var3; ?>" ><span class="icon-users"></span>  Invitaciones<br>Recurrentes</button>
          </div >
        </div >
  </div >
