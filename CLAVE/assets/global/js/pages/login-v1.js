    ...
    if ($('body').data('page') == 'login') {
        ...
        $('#submit-form').click(function(e) {
            form.validate({
                ...
                messages: {
                    celular: {
                        minlength: 'Ingrese celular correcto',
                        maxlength: 'Ingrese celular correcto',
                        required: 'Ingrese celular'
                    },
                    codigo: {
                        minlength: 'Ingrese un código correcto',
                        required: 'Escriba código'
                    },
                    email: {
