...
var counterFinished = function() {
    $('#alerta').load('./tables/facturacion/alerta.php', {tipo:"eliminarT"},function() {  
        alert("Los eventos seleccionados ya no estan disponibles");  
    });

};
var counterAviso = function() {
    var n = noty({
        text        : '<div class="alert alert-danger "><p><strong>Faltan 30s para que caduque las reservas</p></div>',
