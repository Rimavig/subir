...
if(isset($_POST["tipo"])){
    if (isset($_POST["var1"])) {
        $var1 = $_POST['var1'];
        $re = $client->getSalaMapa($var1,"bloqueo");
        $resultado = "".$re;
        $var2 = $_POST['var2'];
        $re = $client->getSalaMapa($var1,"bloqueo");
        $resultado = "".$re;
        $re1 = $client->getAllPlatea($var2);
        $resultado2= "".$re1;
                            ...
                            if (isset($datos[1])) {
                                ...
                                foreach($asientos as $llave => $valores1) {
                                    ...
                                    if($estado=="B" ){
                                        ...
                                        $imagen = "../../../assets/boleto/images/movie/vendido.png";
                                    }else if($estado=="C"){
                                        $imagen = "../../../assets/boleto/images/movie/cortesia.png";
                                    }else if($estado=="E"){
                                        $imagen = "../../../assets/boleto/images/movie/reserva.png";
                                    } else{
                                        if($platea=="A"){
                        ...
                        <div class="row">
                            <div class="col-md-<?php echo $cant; ?>">
                                <div class="form-group" style ="text-align: center;">
                                    ...
                                    <label for="field-4" class="control-label">BLOQUEADOS</label>
                                </div>
                            </div>
                            <div class="col-md-<?php echo $cant; ?>">
                                <div class="form-group" style ="text-align: center;">
                                    <img style="max-width: 40px;"  src="../../../assets/boleto/images/movie/vendido.png" alt="seat">
                                    <label for="field-4" class="control-label">VENDIDOS</label>
                                </div>
                            </div>
                            <div class="col-md-<?php echo $cant; ?>">
                                <div class="form-group" style ="text-align: center;">
                                    <img style="max-width: 40px;"  src="../../../assets/boleto/images/movie/cortesia.png" alt="seat">
                                    <label for="field-4" class="control-label">CORTESIA</label>
                                </div>
                            </div>
                            <div class="col-md-<?php echo $cant; ?>">
                                <div class="form-group" style ="text-align: center;">
                                    <img style="max-width: 40px;"  src="../../../assets/boleto/images/movie/reserva.png" alt="seat">
                                    <label for="field-4" class="control-label">RESERVADO</label>
                                </div>
                            </div>
                            <?php
                            $va= 0;
                            foreach($plateas as $llave => $valores) {
                                ...
                                if (isset($usuario[3])) {
                                    ...
                                    ?>
                                        <div class="col-md-<?php echo $cant; ?>">
                                            <div class="form-group" style ="text-align: center;">
                                                <img style="max-width: 40px;"  src="../../../assets/boleto/images/movie/<?php echo $img; ?>" alt="seat">
