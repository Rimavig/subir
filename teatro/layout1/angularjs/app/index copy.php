...
<html class="no-js">
    ...
    <body ng-app="newApp" class="fixed-topbar fixed-sidebar theme-sdtl color-default" ng-controller="mainCtrl">
                    ...
                    <ul class="nav nav-sidebar">
                        ...
                        <li class="nav-parent">
                            ...
                            <ul class="children collapse">
                                <li class="esconder" ng-class="{ active  : isActive('/perfiles')}"><a href="#perfiles"> Perfiles</a></li>
                                <li ng-class="{ active  : isActive('/usuarios')}"><a href="#usuarios"> Usuarios</a></li>
                                <li ng-class="{ active  : isActive('/usuarios-clientes')}"><a href="#usuarios-clientes"> Usuarios Clientes</a></li>
                                <li ng-class="{ active  : isActive('/usuarios-eventos')}"><a href="#usuarios-eventos"> Usuarios Eventos</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-parent">
                            ...
                            <ul class="children collapse">
                                <li ng-class="{ active  : isActive('/categoria1')}"><a href="#categoria"> Categoría</a></li>
                                <li ng-class="{ active  : isActive('/clasificacion')}"><a href="#clasificacion"> Clasificación</a></li>
                                <li ng-class="{ active  : isActive('/espectaculo')}"><a href="#espectaculo"> Tipo de Espectáculo</a></li>
                                <li ng-class="{ active  : isActive('/procedencia')}"><a href="#procedencia"> Procedencia</a></li>
                                <li ng-class="{ active  : isActive('/tipo-evento')}"><a href="#tipo-evento"> Tipo de Evento</a></li>
                                <li ng-class="{ active  : isActive('/sala')}"><a href="#sala"> Sala</a></li>
                                <li ng-class="{ active  : isActive('/productora')}"><a href="#productora"> Productora</a></li>
                                <li ng-class="{ active  : isActive('/promocion')}"><a href="#promocion"> Promoción</a></li>
                                <li ng-class="{ active  : isActive('/distribucion-principal')}"><a href="#distribucion-principal"> Distribución Principal</a></li>
                                <li ng-class="{ active  : isActive('/distribucion-exterior')}"><a href="#distribucion-exterior"> Distribución Exterior</a></li>
                            </ul>
                        </li>
                        <li class="nav-parent">
                            <a href=""><i class="fa fa-table"></i><span>Imágenes</span><span class="fa arrow"></span></a>
                            <ul class="children collapse">
                                <li ng-class="{ active  : isActive('/imagen_sala')}"><a href="#imagen_sala"> Sala</a></li>
                                <li ng-class="{ active  : isActive('/imagen_distribucion')}"><a href="#imagen_distribucion"> Distribución</a></li>
                                <li ng-class="{ active  : isActive('/imagen_banner')}"><a href="#imagen_banner">Banner</a></li>
                                <li ng-class="{ active  : isActive('/imagen_logo')}"><a href="#imagen_logo"> Logo</a></li>
                            </ul>
                        </li>
                        <li class="nav-parent">
                            <a href=""><i class="fa fa-table"></i><span>Eventos</span><span class="fa arrow"></span></a>
                            <ul class="children collapse">
                                <li ng-class="{ active  : isActive('/evento-venta')}"><a href="#evento-venta"> Venta</a></li>
                                <li ng-class="{ active  : isActive('/evento-gratuito')}"><a href="#evento-gratuito"> Gratuito</a></li>
                                <li ng-class="{ active  : isActive('/evento-informativo')}"><a href="#evento-informativo">Infomativo</a></li>
                                <li ng-class="{ active  : isActive('/evento-eliminar')}"><a href="#evento-eliminar">Bloqueados</a></li>
                            </ul>
                        </li>
                        <li class="nav-parent">
                            <a href=""><i class="fa fa-table"></i><span>Procesos</span><span class="fa arrow"></span></a>
                            <ul class="children collapse">
                                <li ng-class="{ active  : isActive('/distribucion')}"><a href="#distribucion"> Distribución de Sala</a></li>
                                <li ng-class="{ active  : isActive('/cortesia')}"><a href="#cortesia"> Eliminar Cortesia</a></li>
                                <li ng-class="{ active  : isActive('/promociones')}"><a href="#promociones"> Promociones</a></li>
                                <li ng-class="{ active  : isActive('/promociones-general')}"><a href="#promociones-general"> Promociones Generales</a></li>
                            </ul>
                        </li>
                        <li class="nav-parent">
        ...
        <script src="../../../assets/global/js/select/jquery.multi-select.js"></script>
        ...
        <script src="tables/evento/editarEventoCtrl.js"></script>
        <script src="tables/evento/editarEvento_informativo_Ctrl.js"></script>
