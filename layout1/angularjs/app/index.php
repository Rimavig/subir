...
<html class="no-js">
    ...
    <body ng-app="newApp" class="fixed-topbar fixed-sidebar theme-sdtl color-default" ng-controller="mainCtrl">
        ...
        <script type="text/javascript" src="../../../assets/global/plugins/charts-highstock/js/highcharts-all.js"></script>
        <script src="../../../assets/global/plugins/charts-highstock/js/modules/exporting.js"></script>
        ...
        <script src="estado_equipos/dashboardCtrl1.js"></script>
        <script src="telemetria/dashboardCtrl2.js"></script>
