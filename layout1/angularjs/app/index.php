                    ...
                    <ul class="nav nav-sidebar">
                        ...
                        <li class="nav-parent">
                            ...
                            <ul class="children collapse">
                                ...
                                <li class="<?php echo $RAmigosTeatro; ?> " ng-class="{ active  : isActive('/reporte-paymentez')}"><a href="#reporte-paymentez"> Reporte Paymentez</a></li>
                                <li class="<?php echo $RAmigosTeatro; ?> " ng-class="{ active  : isActive('/reporte-pagos')}"><a href="#reporte-pagos"> Reporte Pagos</a></li>
                                <li class="<?php echo $RAmigosTeatro; ?> " ng-class="{ active  : isActive('/reporte-tickets')}"><a href="#reporte-tickets"> Reporte Tickets</a></li>
                                <li class="<?php echo $RAmigosTeatro; ?> " ng-class="{ active  : isActive('/reporte-sala')}"><a href="#reporte-sala"> Reporte Vendidos Sala</a></li>
                            </ul>
                        </li>
                        <?php } ?>
                        <?php if($modulo6){ ?>
