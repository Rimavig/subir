  ...
  .controller('usuariosCtrl', ['$scope','pluginsService', function ($scope,pluginsService) {
    ...
    //PERFIL FACTURACION   
        ...
        $(document).on('click', '.editar_facturacion', function (e) {
            ...
            if(band){
                $('#alerta').load('./tables/usuarios/alerta.php', {tipo:"editarF",id:id, nombres:nombres,apellidos:apellidos,cedula:cedula,razon:razon,ruc:ruc,pasaporte:pasaporte,tipoF:tipo,usuario:idUsuario},function() {    
                    $('.page-spinner-loader').addClass('hide');
                });
            }else{
                $('.page-spinner-loader').addClass('hide');
        ...
        $(document).on('click', '.crear_facturacion', function (e) {
            ...
            if(band){
                $('#alerta').load('./tables/usuarios/alerta.php', {tipo:"crearF", nombres:nombres,apellidos:apellidos,cedula:cedula,razon:razon,ruc:ruc,pasaporte:pasaporte,tipoF:tipo,usuario:id},function() {    
                    $('.page-spinner-loader').addClass('hide');
                });
            }else{
                $('.page-spinner-loader').addClass('hide');
