...
//USUARIOS 
    ...
    if ($_POST["tipo"]==="crear") {
        ...
        $re = $client->insertFacturacion($nombre,$apellido,$tipoF,$cedula,$razon,"A",$usuario, $_SESSION["usuario"]);
        $resultado = "".$re;
        if($resultado=="true"){
            ?>
            <script type="text/javascript"> 
                 var n = noty({
                    text        : '<div class="alert alert-success  "><p><strong>Se Creo facturación correctamente</p></div>',
                    layout      : 'topRight', //or left, right, bottom-right...
                    theme       : 'made',
                    type        : 'error',
                    maxVisible  : 5,
        ...
        if($resultado=="true"){
            ...
            <script type="text/javascript"> 
                 var n = noty({
                    text        : '<div class="alert alert-success  "><p><strong>Se Creo perfil correctamente</p></div>',
                    layout      : 'topRight', //or left, right, bottom-right...
                    theme       : 'made',
                    type        : 'error',
                    maxVisible  : 5,
    ...
    //EDITAR
        ...
        $id=$_POST["id"];
        $re = $client->updateFacturacion($nombre,$apellido,$tipoF,$cedula,$razon,"A",$usuario,$id, $_SESSION["usuario"]);
        $resultado = "".$re;
        if($resultado=="true"){
            ?>
            <script type="text/javascript"> 
        ...
        if($resultado=="true"){
            ...
            <script type="text/javascript"> 
                 var n = noty({
                    text        : '<div class="alert alert-success  "><p><strong>Se edito perfil correctamente</p></div>',
                    layout      : 'topRight', //or left, right, bottom-right...
                    theme       : 'made',
                    type        : 'error',
                    maxVisible  : 5,
            ...
            <script type="text/javascript"> 
                 var n = noty({
                    text        : '<div class="alert alert-warning  "><p><strong>Error el perfil no se pudo edito</p></div>',
                    layout      : 'topRight', //or left, right, bottom-right...
                    theme       : 'made',
                    type        : 'error',
                    maxVisible  : 5,
        ...
        if($resultado=="true"){
            if($estado=="B"){
                ...
                <script type="text/javascript"> 
                     var n = noty({
                    text        : '<div class="alert alert-success  "><p><strong>Se Elimino la facturación correctamente</p></div>',
                    layout      : 'topRight', //or left, right, bottom-right...
                    theme       : 'made',
                    type        : 'error',
                    maxVisible  : 5,
                ...
                <script type="text/javascript"> 
                     var n = noty({
                    text        : '<div class="alert alert-success "><p><strong>Se Edito estado correctamente</p></div>',
                    layout      : 'topRight', //or left, right, bottom-right...
                    theme       : 'made',
                    type        : 'error',
                    maxVisible  : 5,
        ...
        if($resultado=="true"){
            if($estado=="B"){
                ...
                <script type="text/javascript"> 
                     var n = noty({
                    text        : '<div class="alert alert-success  "><p><strong>Se Elimino el perfil correctamente</p></div>',
                    layout      : 'topRight', //or left, right, bottom-right...
                    theme       : 'made',
                    type        : 'error',
                    maxVisible  : 5,
                ...
                <script type="text/javascript"> 
                     var n = noty({
                    text        : '<div class="alert alert-success "><p><strong>Se Edito el perfil correctamente</p></div>',
                    layout      : 'topRight', //or left, right, bottom-right...
                    theme       : 'made',
                    type        : 'error',
                    maxVisible  : 5,
