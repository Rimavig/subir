        ...
        <div class="modal-body">
            <p>Editar Usuario <?php echo $tipo; ?></p>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="form-group prepend-icon">
                                <input type="email" name="correo" class="form-control" id="correo"   value="<?php echo $correo; ?>" placeholder="tsa@hotmail.com" minlength="3"  disabled required>
                ...
                <div class="modal-footer text-center">
                    <button class="btn btn-primary btn-embossed bnt-square editar_usuarioC"  ><i class="fa fa-check"></i> Guardar</button>
