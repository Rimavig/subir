                ...
                <div class="row">  
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-group prepend-icon">
                                <input type="text" name="nombres" ng-model="usuario.nombres" id="nombres" class="form-control" placeholder="Teatro Sanchez Aguilar" minlength="4" id="nombres" required>
                                <i class="icon-user"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-group prepend-icon">
                                <input type="text" name="apellidos" ng-model="usuario.apellidos" id="apellidos" class="form-control" placeholder="Sanchez Aguilar" minlength="4" id="apellidos" required>
                                <i class="icon-user"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-group prepend-icon">
                                <input type="text" name="usuario" ng-model="usuario.usuario" id="usuario"  class="form-control"   placeholder="TSA" minlength="3" id="usuario" required>
                                <i class="icon-user"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="cedula" class="form-control" ng-model="usuario.cedula" id="cedula"   placeholder="0911111111" minlength="10" id="cedula" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="form-group prepend-icon">
                                <input type="text" name="celular" class="form-control" ng-model="usuario.celular" id="celular"   placeholder="0911111111" minlength="10" id="celular" required>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="form-group prepend-icon">
                                <input type="email" name="correo" class="form-control" ng-model="usuario.correo" id="correo"   placeholder="tsa@hotmail.com" minlength="3" id="correo" required>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="form-group prepend-icon">
                                <input type="text" name="direccion" ng-model="usuario.direccion" id="direccion"  class="form-control"   placeholder="Samborondom" minlength="5" id="direccion" required>
                                <i class="icon-map"></i>
                            </div>
                        </div>
                    </div>
