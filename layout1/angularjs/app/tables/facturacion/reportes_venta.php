                ...
                <div class="panel-content pagination2 table-responsive">
                    <div class="row text-center" style="padding-bottom: 40px;">
                        <div class="col-lg-3 col-md-4 col-xs-6 text-center">
                            ...
                            <input type="date" name="fechaI" class="form-control " id="fechaI" style="padding: 0px 10px; width:150px;" value ="<?php echo date("Y-m-d", strtotime(date('Y-m-d')."- 1 week")); ?>" placeholder="07/08/1995"  required>
                        </div>
                        <div class="col-lg-3 col-md-4  col-xs-6 text-center">
                    ...
                    data-table-fechaf="<?php echo date("Y-m-d", strtotime("+1 day")); ?>"  data-table-fechai="<?php echo date("Y-m-d", strtotime(date('Y-m-d')."- 1 week")); ?>" data-table-name="Ventas" id="table-ventas" style="table-layout: fixed;">
                        <thead>
                            <tr>
                                <th>id_compra</th>
                                <th>Factura</th>
