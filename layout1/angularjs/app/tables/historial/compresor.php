...
$re = $client->login("Historial Compresor", $tipo.",".$sucursal);
$resultado = "";
$resultado = "".$re;
        ...
        <div class="col-lg-12 portlets">
            <div class="panel">
                <div class="panel-header panel-controls">
                    <h3><i class="fa fa-table"></i> <strong>Historial de Compresor de Aire</strong></h3>
                </div>
                <div class="panel-content  pagination2 ">
                    <div class="filter-left ">
                        <table class="table filter-footer table-dynamic table-tools " data-table-name="Historial de compresor">
