        ...
        if ($_POST["tipo2"]==="crear") {
            if($resultado=="true"){
                ...
                <script type="text/javascript"> 
                     var n = noty({
                    text        : '<div class="alert alert-success  "><p><strong>Se Creo <?php echo $_POST["nombreT"];?> correctamente</p></div>',
            ...
            if($resultado=="true"){
                ...
                <script type="text/javascript"> 
                     var n = noty({
                    text        : '<div class="alert alert-success  "><p><strong>Se Edito <?php echo $_POST["nombreT"];?> correctamente</p></div>',
                    layout      : 'topCenter', //or left, right, bottom-right...
                    theme       : 'made',
                    type        : 'error',
                    maxVisible  : 5,
            ...
            if($resultado=="true"){
                if($estado=="B"){
                    ...
                    <script type="text/javascript"> 
                        var n = noty({
                        text        : '<div class="alert alert-success  "><p><strong>Se Elimino <?php echo $_POST["nombreT"];?> correctamente</p></div>',
                        layout      : 'topCenter', //or left, right, bottom-right...
                        theme       : 'made',
                        type        : 'error',
                        maxVisible  : 5,
            ...
            if($resultado=="true"){
                ...
                <script type="text/javascript"> 
                    var n = noty({
                    text        : '<div class="alert alert-success  "><p><strong>Se Creo la distribución correctamente</p></div>',
                    layout      : 'topCenter', //or left, right, bottom-right...
                    theme       : 'made',
                    type        : 'error',
                    maxVisible  : 5,
            ...
            if($resultado=="true"){
                ...
                <script type="text/javascript"> 
                    var n = noty({
                    text        : '<div class="alert alert-success  "><p><strong>Se edito la distribución correctamente</p></div>',
                    layout      : 'topCenter', //or left, right, bottom-right...
                    theme       : 'made',
                    type        : 'error',
                    maxVisible  : 5,
