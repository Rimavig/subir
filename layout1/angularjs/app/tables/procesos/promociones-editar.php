                                        ...
                                        <table class="table" id="table-editable2">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a class="delete1 btn btn-sm btn-danger" href="javascript:;"><i class="icon-trash"></i></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>  
                                        ...
                                        <table class="table" id="table-editable3">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a class="delete2 btn btn-sm btn-danger" href="javascript:;"><i class="icon-trash"></i></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>  
                                        ...
                                        <table class="table" id="table-editable4">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <a class="delete3 btn btn-sm btn-danger" href="javascript:;"><i class="icon-trash"></i></a>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>  
