                        ...
                        <?php
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a class="btn btn-sm btn-danger" ng-click="delete_general('<?php echo $prom[0]?>','<?php echo $prom[1]?>','<?php echo $prom[5]?>','<?php echo $estado?>')" style="margin: 5px;"  href="javascript:;"><i class="icon-trash"></i></a>
