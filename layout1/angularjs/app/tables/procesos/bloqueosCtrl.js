        ...
        $(document).ready(function () { 
            ...
            $(document).on('click', '.mapa', function (e) {
                ...
                if(id !="none"){
                    $('.page-spinner-loader').removeClass('hide');
                    if(arr[0] ==="Sala Principal"){
                        $('#verSala1').load('./tables/procesos/ver_salaG.php', {var1:funcion, tipo:"bloqueo"},function() {    
                            $('.page-spinner-loader').addClass('hide');
            ...
            $(document).on('click', '.seat-free img', function (e) {
                ...
                if ( tipo=="C"){
                    if(filename == "disponible.png" | filename == "bloqueo.png" |filename == "area2.png" | filename == "area3.png" | filename == "area4.png" | filename == "area5.png" | filename == "area6.png") {
                    ...
                    if(filename == "disponible.png" | filename == "area2.png" | filename == "area3.png" | filename == "area4.png" | filename == "area5.png" | filename == "area6.png") {
                        $(this).attr("src","../../../assets/boleto/images/movie/bloqueo.png");
                        $('#mensaje3').tagsinput('add',  $(this)[0].id);
                    }
                }else if ( tipo=="D" ){
                    if(filename == "bloqueo.png") {
                        $(this).attr("src","../../../assets/boleto/images/movie/disponible.png");
                        $('#mensaje3').tagsinput('add',  $(this)[0].id);
                    }
                }
            });
            $(document).on('beforeItemRemove', '#mensaje3', function (e) {
                ...
                if ( tipo=="C"){
                    if(texto.includes(tag)){
                        ...
                        $("#"+tag).attr("src","../../../assets/boleto/images/movie/disponible.png");
                    }
                }else if ( tipo=="D" ){
                    $("#"+tag).attr("src","../../../assets/boleto/images/movie/bloqueo.png");
                }
            ...
            $(document).on('change','.reserva' ,function(e) {
                ...
                if(tipo=="asiento"){
                    ...
                    asiento.value="";
                    var funcion=$(this).parents().find('.funciones')[0].value;
                    $('#verSala1').load('./tables/procesos/ver_sala.php', {var1:funcion, tipo:"bloqueo"},function() {    
                        $('.page-spinner-loader').addClass('hide');
                        $(this).parents().find('#verSala1').show(); 
