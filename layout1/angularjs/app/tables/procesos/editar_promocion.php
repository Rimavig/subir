...
<div class="modal-dialog modal-lg">
    <div class="modal-content ">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Editar Promoción (<?php echo $nombre; ?>)</strong> </h4> 
        ...
        <div class="modal-body">
            <form role="form" class=" form-validation">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="switch switch-green">
                                    <input type="checkbox" class="switch-input"  id="Amigosbox" <?php echo $estado; ?>>
                ...
                <div class="row">
                    ...
                    <div class="col-md-1">
                        <div class="form-group">
                            ...
                            <div class="form-group ">
                                <input class="form-control input-sm" id="Cmaxima"  value="<?php echo $Cmaximo; ?>" type="number" value="1" min="0" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        ...
                        <div class="row" id="cruzados">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control input-sm" type="number" value ="<?php echo $desde; ?>" id="cantidad1" placeholder="" min="0" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control input-sm" id="CRdescuento" value ="<?php echo $descuento; ?>" type="number" name="duracionE" placeholder="" min="0" required>
                                    </div>
                                </div>
                            </div>            
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input class="form-control input-sm" type="number" value ="<?php echo $hasta; ?>" id="cantidad2" placeholder="" min="0" required>
                                    </div>
                                </div>
                            </div>  
                        </div> 
                ...
                <div class="modal-footer text-center">
                    <button type="submit" class="btn btn-primary btn-embossed bnt-square editar_promocion" ><i class="fa fa-check"></i> Guardar</button>
