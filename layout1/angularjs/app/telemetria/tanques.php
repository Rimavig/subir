...
foreach($historial as $llave => $valores) {
    ...
    if (isset($datos[1])) {
        $combustible=$datos[0];
        $nombre=$datos[1];
        $cantidad_actual=number_format($datos[2], 2, '.', ',');
        $cantidad_por=number_format($datos[3], 2, '.', ',');
        $capacidad=number_format($datos[4], 2, '.', ',');
        //$capacidad=$datos[4];
        $altura=number_format($datos[5], 2, '.', ',')." CM";
        $volumen=number_format($datos[6], 2, '.', ',')." GL";
        $cantidad_maxima=number_format($datos[7], 2, '.', ',');
        $cantidad_maxima1=$datos[7];
        $cantidad_minima1=$datos[8];
        $cantidad_minima=number_format($datos[8], 2, '.', ',');
        $id=$datos[9];
                ...
                <div class="row rejilla" >  
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
                        <div class="row rejilla" >   
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6" style="padding:0px;">
                                <label ><?php echo $capacidad; ?> GL</label>
                            </div>
                        </div>
                    </div> 
                    <div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
                        <div class="row rejilla" >   
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6" style="padding:0px;">
                                <label ><?php echo $cantidad_minima; ?> GL</label>
                            </div>
                        </div>
                    </div> 
                    <div class="col-md-12 col-sm-12 col-xs-12" style="padding:0px;">
                        <div class="row rejilla" >   
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6" style="padding:0px;">
                                <label ><?php echo $cantidad_maxima; ?> GL</label>
                            </div>
                        </div>
                    </div> 
                    <div class="col-md-12 col-sm-12 col-xs-12 <?php echo $esconder; ?>" style="padding:0px;">
                        <div class="row rejilla" >   
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6" style="padding:0px;">
                                <input class="form-control input-sm valmin<?php echo  str_replace(' ', '',$nombre); ?>" type="number" value="<?php echo $cantidad_minima1; ?>" placeholder="Type a number" id="valmin<?php echo str_replace(' ', '',$nombre);; ?>">
                            </div>
                        </div>
                    </div> 
                    <div class="col-md-12 col-sm-12 col-xs-12 <?php echo $esconder; ?>" style="padding:0px;">
                        <div class="row rejilla" >   
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6" style="padding:0px;">
                                <input class="form-control input-sm valmax<?php echo str_replace(' ', '',$nombre);?>" type="number" value="<?php echo $cantidad_maxima1; ?>" placeholder="Type a number" id="valmax<?php echo str_replace(' ', '',$nombre);; ?>">
                            </div>
                        </div> 
                    </div>
                    <div class="col-md-12 col-sm-12 col-xs-12 <?php echo $esconder; ?>" style="padding:0px;">
