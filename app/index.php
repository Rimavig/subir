                    ...
                    <ul class="nav nav-sidebar">
                        ...
                        <li class="nav-parent">
                            ...
                            <ul class="children collapse">
                                ...
                                <li class="<?php echo $TprocesosAmigosB; ?> " ng-class="{ active  : isActive('/amigos')}"><a href="#amigos"> Amigos del Teatro</a></li>
                        ...
                        <li class="nav-parent">
                            ...
                            <ul class="children collapse">
                                ...
                                <li class="<?php echo $TwebOtrasImagen; ?> " ng-class="{ active  : isActive('/imagenes_webO')}"><a href="#imagenes_webO"> Otas Imágenes</a></li>
