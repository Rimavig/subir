  ...
  .controller('webCtrl', ['$scope','pluginsService', function ($scope ,pluginsService) {
    $(document).ready(function () { 
        ...
        $('#teatroInstalaciones').load('./tables/web/instalaciones.php', function() {    
            $("#table-instalaciones").dataTable({ "language": {
                ...
                "aoColumnDefs": [
                    ...
                    { "sWidth": "10%", "className": "text-center", "aTargets": [5,3]},
        ...
        $('#otrasPreguntas').load('./tables/web/preguntas.php', function() {    
            $("#table-preguntas").dataTable({ "language": {
                ...
                "aoColumnDefs": [
                    ...
                    { "sWidth": "10%", "className": "text-center", "aTargets": [2,4]}
            ]}); 
        });
      ...
      $scope.$on('$viewContentLoaded', function () {
        ...
        $(document).on('click', '.guardarBpBambiental', function (e) {
            e.preventDefault();
            e.stopImmediatePropagation();
            $(this).prop("disabled",true); 
            var imagen=$(this).parents().find('.BpBambiental').children()[0];
            var Himagen="";
            var band=true;
            if (imagen != null) {
                Himagen = imagen.src;
            ...
            if (band){
                $('.page-spinner-loader').removeClass('hide'); 
                $('#alerta').load('./tables/web/alerta.php', {tipo:"guardarImagen",tipo2:"BpBambiental", Himagen:Himagen,},function() {    
                    $('.page-spinner-loader').addClass('hide');
                });
            }else{
                $(this).prop("disabled",false); 
      ...
      $scope.$on('$destroy', function () {
        ...
        $(document).off('click','.guardarBpBambiental');
