...
$re = $client->getPerfilRol($_SESSION["id"],"61");
$resultado = "".$re;
        ...
        <div class="col-lg-12 portlets">
            <div class="panel">
                <div class="panel-header panel-controls">
                    <h3><i class="fa fa-table"></i> Regalo  <strong>Para ti</strong> </h3>
                </div>
                <input type="text"  id="idCorreo" class="esconder"  value="6" disabled> 
                ...
                <div class="panel-content pagination2 ">
                    ...
                    <div class="row">   
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" rows="2" id="cke-editor11" data-sample-short><?php echo $descripcion1; ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="field-1" class="control-label">Descripción 2</label>
                            <div class="form-group">
                                <textarea class="form-control" rows="2" id="cke-editor12" data-sample-short><?php echo $descripcion2; ?></textarea>
                            </div>
                        </div>
                    </div> 
                    <div class="row">  
