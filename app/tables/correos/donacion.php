...
$re = $client->getPerfilRol($_SESSION["id"],"59");
$resultado = "".$re;
        ...
        <div class="col-lg-12 portlets">
            <div class="panel">
                <div class="panel-header panel-controls">
                    <h3><i class="fa fa-table"></i> <strong>Donación</strong> </h3>
                </div>
                ...
                <div class="panel-content pagination2 ">
                    ...
                    <div class="row">   
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <textarea class="form-control" rows="2" id="cke-editor7" data-sample-short><?php echo $descripcion1; ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label for="field-1" class="control-label">Descripción 2</label>
                            <div class="form-group">
                                <textarea class="form-control" rows="2" id="cke-editor8" data-sample-short><?php echo $descripcion2; ?></textarea>
                            </div>
                        </div>
                    </div> 
                    <div class="row">  
