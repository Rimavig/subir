...
<table class="table" data-table-name="Promoción Forma de Pago" id="table-editable3" >
    ...
    <?php
        ...
        ?>
        <tr>
            <td class="esconder" id="fila0T"> <?php if (isset($prom[0])) {echo $prom[0]; }  ?> </td>
            <td class="esconder" id="fila0PromocionT"> <?php if (isset($prom[1])) {echo $prom[1]; }  ?> </td>
            <?php
                if ($prom[3]=="T") {
                    $localidad="TODAS";
                }else if ($prom[3]=="W") {
            ...
            <th>
                ...
                <div class="form-group">
                    <label class="switch switch-green">
                        <input type="checkbox" class="switch-input"  id="Tbox" <?php echo $estado; ?> disabled>
                        <span class="switch-label" data-on="On" data-off="Off"></span>
                        <span class="switch-handle"></span>
                        <span id="Testado" class="esconder"><?php echo $estadoT; ?></span>
                    </label>
                </div>
            </th>
            <td class="text-right">
                <a class="editarPromoT btn btn-sm btn-dark <?php echo $editar; ?> " style="margin: 5px;"  href="javascript:;"><i class="icon-note"></i></a>
                <a class="deleteT  btn btn-sm btn-danger <?php echo $eliminar; ?> " style="margin: 5px;"  href="javascript:;"><i class="icon-trash"></i></a>
                <a class="estadoT  btn btn-sm btn-blue <?php echo $estad; ?> " style="margin: 5px;"  style="margin: 0px;" href="javascript:;"><i class="icon-key"></i></a>
            </td>
        </tr>
        <?php
            }
