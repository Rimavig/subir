...
<table class="table" data-table-name="Promoción Forma de Pago" id="table-editable3" >
    ...
    <?php
        ...
        <tr>
            ...
            <td> <?php if (isset($prom[11])) {echo $prom[11]; }  ?> </td>
            ...
            <td class="text-right">
                <a class="editarPromoCR btn btn-sm btn-dark <?php echo $editar; ?>" style="margin: 5px;"  href="javascript:;"><i class="icon-note"></i></a>
                <a class="deleteCR  btn btn-sm btn-danger <?php echo $eliminar; ?> " style="margin: 5px;"  href="javascript:;"><i class="icon-trash"></i></a>
                <a class="estadoCR  btn btn-sm btn-blue <?php echo $estad; ?>" style="margin: 5px;"  style="margin: 0px;" href="javascript:;"><i class="icon-key"></i></a>
            </td>
        </tr>
        <?php
            }
