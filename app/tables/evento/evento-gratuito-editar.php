        ...
        <div class="col-lg-12 portlets">
            <div class="panel">
                <div class="panel-header panel-controls">
                    <h3><i class="fa fa-table"></i> Tabla de <strong>Eventos Gratuitos</strong> </h3>
                </div>
                            ...
                            <div class="panel-content pagination2 table-responsive">
                                ...
                                <div class="m-b-20">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="field-1" class="control-label">Link de Formulario</label>
                                                    <input type="text" name="nombreE" class="form-control" value="" placeholder="Link del formulario" minlength="5" id="formulario1"  required>
                                                </div>
                                            </div>                
                                        </div>  
                                        <div class="modal-footer text-center">
                                            <button  class="btn btn-primary btn-embossed bnt-square formulario" ><i class="fa fa-check"></i> Guardar</button>
                                            <button type="reset" class="btn btn-embossed btn-default">Limpiar</button>
                                        </div>
                                   
                                    <div id="formulario" style="text-align:center">
                                    <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSetN50lUObGMERtxmJWhALvxmIuVlYOUPr22QVeggNGz-zn_Q/viewform?embedded=true" width="640" height="947" frameborder="0" marginheight="0" marginwidth="0">Cargando…</iframe>
                                    </div>
                                </div>      
                            </div>
                        </tab>
