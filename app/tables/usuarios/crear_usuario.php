        ...
        <div class="modal-body">
            <p>Crear Usuario <?php echo $tipo; ?> al Sistema</p>
                <div class="row">  
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-group prepend-icon">
                                <input type="text" name="nombres" id="nombres" class="form-control" placeholder="Teatro Sanchez Aguilar" minlength="4" id="nombres" required>
                                <i class="icon-user"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="form-group prepend-icon">
                                <input type="text" name="usuario" id="usuario"  class="form-control"   placeholder="TSA" minlength="3" id="usuario" required>
                                <i class="icon-user"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="cedula" class="form-control" id="cedula"   placeholder="0911111111" minlength="10" id="cedula" required>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="form-group prepend-icon">
                                <input type="text" name="celular" class="form-control" id="celular"   placeholder="0911111111" minlength="10" id="celular" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="form-group prepend-icon">
                                <input type="text" name="direccion" id="direccion"  class="form-control"   placeholder="Samborondom" minlength="5" id="direccion" required>
                                <i class="icon-map"></i>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="form-group prepend-icon">
                                <input type="date" name="fecha" id="fecha"  class="form-control" style="padding: 0px 30px;"   placeholder="07/08/1995" id="nacimiento" required>
                ...
                <div class="modal-footer text-center">
                    <button class="btn btn-primary btn-embossed bnt-square <?php echo $editar; ?>"  ><i class="fa fa-check"></i> Crear</button>
