                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a class="deleteE btn btn-sm btn-danger" href="javascript:;"><i class="icons-office-52"></i></a>
                                    <a class="estadoE btn btn-sm btn-blue" style="margin: 0px;" href="javascript:;"><i class="icon-key"></i></a>
                                </td>
                            </tr>
                            <?php
                             }
