...
$re2 =$client3->getAllUsuarioCliente2();
...
foreach($usuarios as $llave => $valores) {
    ...
    if (isset($usuario[2]) && $usuario[0] !=1 ) {
        ...
        $data[]=array($usuario[0],$usuario[1],$usuario[2],$usuario[3],$usuario[4],$usuario[6],$usuario[5],$usuario[13],$usuario[7],$usuario[9],$usuario[10],$usuario[11],$usuario[14],$est1,$text);
    } 
} 
$dataT['data']=$data;   
