...
var MakeApp = angular
  ...
  .config(function ($routeProvider) {
      $routeProvider
        .when('/', {
            templateUrl: 'dashboard/dashboard_inicio.php',
            controller: 'dashboardInicioCtrl'
        })
        ...
        .when('/reporte-tickets', {
            templateUrl: 'tables/reportes/evento-tickets.php',
            controller: 'reportesCtrl'
        })
        .when('/reporte-sala', {
            templateUrl: 'tables/reportes/evento-sala.php',
            controller: 'reportesCtrl'
        })
        .when('/reporte-cumpleanos', {
            templateUrl: 'tables/reportes/reporte_cumpleanos.php',
            controller: 'reportesCtrl'
        })
        .when('/reporte-regalo', {
            templateUrl: 'tables/reportes/reporte_regalo.php',
            controller: 'reportesCtrl'
        })
        .when('/reporte-completo', {
            templateUrl: 'tables/reportes/reporte_completo.php',
            controller: 'reportesCtrl'
        })
        //correos 
        ...
        .when('/error-facturacion', {
            templateUrl: 'tables/facturacion/errores_venta.php',
            controller: 'facturacionCtrl'
        })
        .when('/error-pagos', {
        ...
        .when('/reportes-eliminadas', {
            templateUrl: 'tables/facturacion/reportes_eliminadas.php',
            controller: 'facturacionCtrl'
        })
        .when('/reportes-notas', {
            templateUrl: 'tables/facturacion/reportes_notas.php',
            controller: 'facturacionCtrl'
        })
