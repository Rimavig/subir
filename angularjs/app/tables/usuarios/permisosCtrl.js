    ...
    $scope.$on('$viewContentLoaded', function () {
        ...
        $(document).on('change','#admin' ,function(e) {
            ...
            if(this.checked) {
                ...
                $(this).parents().find('#Dashboard').iCheck('check');
                ...
                $(this).parents().find('#TprocesosNotificacion').iCheck('check');
                $(this).parents().find('#TprocesosCalendario').iCheck('check');
                ...
                $(this).parents().find('#RVentasEliminadas').iCheck('check');
                $(this).parents().find('#RNotasCredito').iCheck('check');
                $(this).parents().find('#ErrorFacturacion').iCheck('check');
                $(this).parents().find('#ErrorPagos').iCheck('check');
                $(this).parents().find('#ErrorCompras').iCheck('check');
                ...
                $(this).parents().find('#RPaymentez').iCheck('check');
                $(this).parents().find('#RPagos').iCheck('check');
                $(this).parents().find('#RTickets').iCheck('check');
                $(this).parents().find('#RVendidosSala').iCheck('check');
                $(this).parents().find('#RCumpleanos').iCheck('check');
                $(this).parents().find('#RRegalo').iCheck('check');
                $(this).parents().find('#RCompleto').iCheck('check');
        ...
        seleccionar('#TprocesosNotificacion','PNF');
        seleccionar('#TprocesosCalendario','PCD');
        //MODULO WEB
        ...
        seleccionar('#RVentasEliminadas','RVE');
        seleccionar('#RNotasCredito','RNC');
        seleccionar('#ErrorFacturacion','EFT');
        seleccionar('#ErrorPagos','EPG');
        seleccionar('#ErrorCompras','ECP');
        ...
        seleccionar('#RPaymentez','RPM');
        seleccionar('#RPagos','RPG');
        seleccionar('#RTickets','RTC');
        seleccionar('#RVendidosSala','RVS');
        seleccionar('#RCumpleanos','RCP');
        seleccionar('#RRegalo','RRG');
        seleccionar('#RCompleto','RCG');
        ...
        $(document).on('click', '.crear_perfil', function (e) {
            ...
            permisos=permisos +verificar('#Dashboard','DSB');
            //MODULO MANTENIMIENTO
            ...
            permisos=permisos +verificar('#TprocesosNotificacion','PNF');
            permisos=permisos +verificar('#TprocesosCalendario','PCD');
            //MODULO WEB
            ...
            permisos=permisos +verificar('#RVentasEliminadas','RVE');
            permisos=permisos +verificar('#RNotasCredito','RNC');
            permisos=permisos +verificar('#ErrorFacturacion','EFT');
            permisos=permisos +verificar('#ErrorPagos','EPG');
            permisos=permisos +verificar('#ErrorCompras','ECP');
            //MODULO CORREOS
            ...
            permisos=permisos +verificar('#RPaymentez','RPM');
            permisos=permisos +verificar('#RPagos','RPG');
            permisos=permisos +verificar('#RTickets','RTC');
            permisos=permisos +verificar('#RVendidosSala','RVS');
            permisos=permisos +verificar('#RCumpleanos','RCP');
            permisos=permisos +verificar('#RRegalo','RRG');
            permisos=permisos +verificar('#RCompleto','RCG');
