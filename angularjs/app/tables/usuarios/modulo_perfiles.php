...
?>
 <div class="panel-body">                          
    <div class="row" >
        ...
        <div  class="col-md-3 col-sm-3 col-xs-6" style ="margin-bottom: 30px!important;">
            <div class="form-group">
                <p><label><input type="checkbox" class="Dashboard" id="Dashboard" data-checkbox="icheckbox_minimal-red"><strong>DASHBOARD</strong></p>
                <div class="input-group">
                    <div class="icheck-list">
                        <label><input type="checkbox" id="exportarDSB" <?php echo $exportarDSB; ?> data-checkbox="icheckbox_flat-blue"> VER</label>
                    </div>
                </div>
            </div>       
        </div>
