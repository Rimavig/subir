...
$lista=array("PS","CT","PP","PPG","PAB","PAP","PAI","PC","PF","PPF","PNF","PCD");
...
<div class="panel-body">
    <div class="row">  
        ...
        <div  class="col-md-3 col-sm-3 col-xs-6" style ="margin-bottom: 30px!important;">
            <div class="form-group">
                <p><label><input type="checkbox" class="TprocesosNotificacion" id="TprocesosNotificacion" data-checkbox="icheckbox_minimal-red"><strong>NOTIFICACIONES</strong></p>
                <div class="input-group">
                    <div class="icheck-list">
                        <label><input type="checkbox" id="exportarPNF" <?php echo $exportarPNF; ?>  data-checkbox="icheckbox_flat-blue"> Exportar</label>
                        <label><input type="checkbox" id="crearPNF" <?php echo $crearPNF; ?> data-checkbox="icheckbox_flat-blue"> Crear</label>
                        <label><input type="checkbox" id="editarPNF" <?php echo $editarPNF; ?>  data-checkbox="icheckbox_flat-blue"> Eliminar</label>
                    </div>
                </div>
            </div>       
        </div>
        <div  class="col-md-3 col-sm-3 col-xs-6" style ="margin-bottom: 30px!important;">
            <div class="form-group">
                <p><label><input type="checkbox" class="TprocesosCalendario" id="TprocesosCalendario" data-checkbox="icheckbox_minimal-red"><strong>CALENDARIO</strong></p>
                <div class="input-group">
                    <div class="icheck-list">
                        <label><input type="checkbox" id="exportarPCD" <?php echo $exportarPCD; ?>  data-checkbox="icheckbox_flat-blue"> Exportar</label>
                        <label><input type="checkbox" id="crearPCD" <?php echo $crearPCD; ?> data-checkbox="icheckbox_flat-blue"> Crear</label>
                        <label><input type="checkbox" id="editarPCD" <?php echo $editarPCD; ?>  data-checkbox="icheckbox_flat-blue"> Editar</label>
                    </div>
                </div>
            </div>       
        </div>
