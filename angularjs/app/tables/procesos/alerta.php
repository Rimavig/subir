...
if (isset($_POST["cantidad"])) {
    ...
    function esconder(){
        ...
        $('#verSala1').load('./tables/procesos/ver_sala.php', {var1:<?php echo $funcion; ?>, var2:<?php echo $idEvento; ?>, tipo:"bloqueo"},function() {    
            $('.page-spinner-loader').addClass('hide');
    ...
    function esconder(){
        ...
        $('#verSala1').load('./tables/procesos/ver_salaG.php', {var1:<?php echo $funcion; ?>, var2:<?php echo $idEvento; ?>, tipo:"bloqueo"},function() {    
            $('.page-spinner-loader').addClass('hide');
            $(this).parents().find('#verSala1').show();
        });
