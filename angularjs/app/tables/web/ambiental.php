...
$re = $client->getAllInformacionTabla('ambiental');
$resultado= "".$re;
...
<div class="btn-group <?php echo $crear; ?>">
    <button class="crearResponsabilidad btn btn-sm btn-dark "  href="javascript:;"><i class="fa fa-plus"></i> Responsabilidad Ambiental</button>
</div>
<table class="table" data-table-name=" Responsabilidad Ambiental" id="table-ambiental" style="table-layout: fixed;">
    <thead>
        <tr>
            <th>Id</th>
            <th>Imagen (467x307)</th>
            <th>Orden </th>
            <th>Título </th>
            <th>Descripción</th>
            <th>Estado</th>
    ...
    <?php
        ...
        <tr>
            ...
            <td class="text-right">
                <a class="editarResponsabilidad btn btn-sm btn-dark  <?php echo $editar; ?>" style="margin: 5px;  "  href="javascript:;"><i class="icon-note"></i></a>
