...
$re = $client->getAllInformacionWeb('proyectos');
$resultado= "".$re;
...
$re = $client->getAllInformacionTabla('proyectos');
$resultado= "".$re;
$instalaciones =explode(';;;',$resultado);

$re = $client->getPerfilRol($_SESSION["id"],"48");
$resultado = "".$re;
...
<div class="col-md-12"> 
        <div class="panel-header panel-controls">
            <div class="col-md-12">
                <textarea class="form-control" id="proyectosInfoT" rows="5"><?php echo $quienes; ?></textarea>
                <div class="modal-footer text-center">
                    <button type="submit" class="btn btn-embossed btn-danger guardarProyectosT <?php echo $editar; ?>" ><i class="fa fa-save"></i> Guardar</button>
                </div>
            </div>
        </div>
    </div>
<div class="btn-group <?php echo $crear; ?>">
    <button class="crearProyecto btn-sm btn-dark "  href="javascript:;"><i class="fa fa-plus"></i> Proyectos con el Teatro</button>
</div>
<table class="table" data-table-name="Proyectos con el Teatro" id="table-noticias" style="table-layout: fixed;">
    <thead>
        <tr>
            <th>Id</th>
    ...
    <?php
        ...
        <tr>
            ...
            <td class="text-right">
                <a class="editarProyecto btn btn-sm btn-dark <?php echo $editar; ?>" style="margin: 5px;  "  href="javascript:;"><i class="icon-note"></i></a>
