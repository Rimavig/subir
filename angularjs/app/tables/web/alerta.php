...
if (isset($_POST["tipo"])) {
    ...
    if ( $tipo=="guardarQuienes"){
        ...
        $resultado = "".$re;
    }else if ( $tipo=="guardarUrl"){
        $url = $_POST['url'];
        $re = $client->updateImagen("Principal",$url,"banner","A","10",$_SESSION["usuario"]);
        $resultado = "".$re;
...
if($resultado=="true"){
    if(isset($_POST["tipo"])){
        ...
        if ( $tipo=="guardarQuienes" | $tipo=="guardarMisionT" | $tipo=="guardarVisionT" | $tipo=="guardarNosotrosT"){
            ...
            <?php
        }else if ( $tipo=="estadoIP" |  $tipo=="guardarUrl"){
            ?>
            <script type="text/javascript"> 
            var n = noty({
                text        : '<div class="alert alert-success "><p><strong>Se editó correctamente</p></div>',
                ...
                $(".guardarUrl").prop("disabled",false);
            </script>
            <?php
        }else if ( $tipo=="estadoInstalacion"){
            ?>
