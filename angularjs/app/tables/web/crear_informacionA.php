...
<div class="modal-dialog modal-lg modal-mantenimiento">
    <div class="modal-content ">
        <div class="modal-header">
            ...
            <h4 class="modal-title">Crear Información Adicional </h4>
        </div>
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" id="Idescripcion" rows="4"></textarea>
                    </div>
                </div>
            </div>
            <div class="modal-footer text-center">
                <button type="submit" class="btn btn-primary btn-embossed bnt-square crear_InformacionA" ><i class="fa fa-check"></i> Crear</button>
