...
$re = $client->getAllInformacionTabla('instalaciones');
$resultado= "".$re;
...
<div class="btn-group <?php echo $crear; ?>">
    <button class="crearInstalacion btn-sm btn-dark "  href="javascript:;"><i class="fa fa-plus"></i> Instalaciones</button>
</div>
<table class="table" data-table-name="Instalaciones" id="table-instalaciones" style="table-layout: fixed;">
    <thead>
        <tr>
            <th>Id</th>
    ...
    <?php
        ...
        <tr>
            ...
            <td class="text-right">
                <a class="editarInstalacion btn btn-sm btn-dark  <?php echo $editar; ?>" style="margin: 5px;  "  href="javascript:;"><i class="icon-note"></i></a>
