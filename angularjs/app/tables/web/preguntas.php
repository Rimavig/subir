...
$re = $client->getAllInformacionTabla('preguntas');
$resultado= "".$re;
$instalaciones =explode(';;;',$resultado);

$re = $client->getPerfilRol($_SESSION["id"],"39");
$resultado = "".$re;
...
<div class="btn-group  <?php echo $crear; ?>">
    <button class="crearPreguntaF btn btn-sm btn-dark "  href="javascript:;"><i class="fa fa-plus"></i> Preguntas Frecuentes</button>
</div>
<table class="table" data-table-name="Preguntas Frecuentes" id="table-preguntas" style="table-layout: fixed;">
    <thead>
        <tr>
            <th>Id</th>
            <th>Orden </th>
    ...
    <?php
        ...
        <tr>
            ...
            <td class="text-right">
                <a class="editarPreguntaF btn btn-sm btn-dark <?php echo $editar; ?>" style="margin: 5px;  "  href="javascript:;"><i class="icon-note"></i></a>
