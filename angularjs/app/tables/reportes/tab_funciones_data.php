...
foreach($usuarios1 as $llave => $valores1) {
    if($valores1==="2"){
        $editar='<a class="editarFuncion btn btn-sm btn-dark" style="margin: 5px 0px;  "  href="javascript:;"><i class="icon-note"></i></a>';
    }
}
if (isset($_GET["var1"])) {
    $var1 = $_GET['var1'];
...
foreach($funciones as $llave => $valores) {
    ...
    if (isset($funcion[2])) {
        ...
        $data[]=array($funcion[0],$funcion[1],$funcion[2],$funcion[3],$funcion[4],$funcion[5],$funcion[6],$funcion[7],$funcion[8],$est1,$text);
    } 
} 
$dataT['data']=$data;   
