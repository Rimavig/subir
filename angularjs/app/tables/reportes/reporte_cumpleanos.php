...
$re = $client->getPerfilRol($_SESSION["id"],"79");
$resultado = "".$re;
        ...
        <div class="col-lg-12 portlets">
            <div class="panel">
                <div class="panel-header panel-controls">
                    <h3><i class="fa fa-table"></i> Reporte <strong>Cumpleaños</strong> </h3>
                </div>
                <div class="panel-content pagination2 table-responsive">
                    ...
                    <table class="table filter-footer  cumpleanos_data <?php echo $exportar; ?> table-dynamic table-cumpleanos" 
                    data-table-fechaf="<?php echo date("Y-m-d", strtotime("+1 day")); ?>"  data-table-fechai="<?php echo date("Y-m-d", strtotime(date('Y-m-d')."- 1 month")); ?>" data-table-name="Promoción Cumpleaños" id="table-editable" style="table-layout: fixed;">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Nombres</th>
