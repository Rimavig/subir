...
if (isset($_GET["var1"])) {
    $var1 = $_GET['var1'];
    $re = $client->getAllTickets($var1,"ticket");
    $resultado= "".$re;
...
foreach($funciones as $llave => $valores) {
    ...
    if (isset($funcion[2])) {
        ...
        $data[]=array($funcion[0],$funcion[1],$fact,$localidad,$funcion[3],$funcion[4],$funcion[5],$funcion[6],$funcion[7],$funcion[9],$funcion[12],$est1,$text);
    } 
} 
$dataT['data']=$data;   
