...
foreach($funciones as $llave => $valores) {
    ...
    if (isset($funcion[2])) {
        ...
        $data[]=array($funcion[0],$funcion[1],$fact,$localidad,$funcion[3],$funcion[4],$funcion[5],$funcion[11],$funcion[12],$funcion[13],$funcion[14],$funcion[15],$funcion[16],$funcion[6],$funcion[7],$funcion[8],$est1,$text);
    } 
} 
$dataT['data']=$data;   
