...
<div class="modal-dialog modal-mantenimiento ">
    <div class="modal-content  ">
        ...
        <div class="modal-footer text-center">
            ...
            <button type="button" class="btn btn-danger btn-embossed editar_evento">Guardar</button>
            <button type="button" class="btn btn-dark btn-embossed eliminar_evento">Eliminar</button>
        </div>
    </div>
</div>
