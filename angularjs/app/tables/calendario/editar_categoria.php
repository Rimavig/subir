...
<div class="modal-dialog modal-mantenimiento ">
    <div class="modal-content  ">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-control form-white" id="colorC" data-placeholder="Escoger un color..." name="category-color">
                        <option value="bg-success" <?php echo $var1;?>>Verde</option>
                        <option value="bg-red" <?php echo $var2;?>>Rojo</option>
                        <option value="bg-blue" <?php echo $var3;?>>Azul</option>
                        <option value="bg-warning" <?php echo $var4;?>>Amarillo</option>
                    </select>
                </div>
            </div>
        </div>
        <div class="modal-footer text-center">
            ...
            <button type="button" class="btn btn-danger btn-embossed editar_category" data-dismiss="modal">Guardar</button>
        </div>
    </div>
</div>
