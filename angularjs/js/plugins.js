        ...
        if ($('.table-dynamic').length && $.fn.dataTable) {
            ...
            $('.table-dynamic').each(function () {
                ...
                if(lon==1){
                    if ($(this).hasClass('bloqueados_data')) {
                    ...
                    }else if ($(this).hasClass('clientes_dataR2')) {
                        carga="tables/usuarios/usuarios-clientes_data2.php";    
                        ...
                        var txt=$(this).data('table-fechai'); 
                        var txt2=$(this).data('table-fechaf');
                        carga="tables/facturacion/reportes_venta_data.php?var1="+txt+"&var2="+txt2;
                    }else if ($(this).hasClass('reportesE_data')) {
                        var txt=$(this).data('table-fechai'); 
                        var txt2=$(this).data('table-fechaf');
                        carga="tables/facturacion/reportes_eliminadas_data.php?var1="+txt+"&var2="+txt2;
                    }else if ($(this).hasClass('reportesN_data')) {
                        var txt=$(this).data('table-fechai'); 
                        var txt2=$(this).data('table-fechaf');
                        carga="tables/facturacion/reportes_notas_data.php?var1="+txt+"&var2="+txt2;
                    }else if ($(this).hasClass('paymentez_data')) {
                        var txt=$(this).data('table-fechai'); 
                        var txt2=$(this).data('table-fechaf');
                        carga="tables/reportes/reporte_paymentez_data.php?var1="+txt+"&var2="+txt2;
                    }else if ($(this).hasClass('paymentez_pago_data')) {
                        var txt=$(this).data('table-fechai'); 
                        var txt2=$(this).data('table-fechaf');
                        carga="tables/reportes/reporte_pagos_data.php?var1="+txt+"&var2="+txt2;
                    }else if ($(this).hasClass('errorF_data')) {
                    ...
                    }else if ($(this).hasClass('venta_tickets')) {
                        carga="tables/reportes/evento-tickets_data.php";
                    }else if ($(this).hasClass('venta_sala')) {
                        carga="tables/reportes/evento-sala_data.php";
                    }else if ($(this).hasClass('cumpleanos_data')) {
                        var txt=$(this).data('table-fechai'); 
                        var txt2=$(this).data('table-fechaf');
                        carga="tables/reportes/reporte_cumpleanos_data.php?var1="+txt+"&var2="+txt2;
                    }else if ($(this).hasClass('regalo_data')) {
                        var txt=$(this).data('table-fechai'); 
                        var txt2=$(this).data('table-fechaf');
                        carga="tables/reportes/reporte_regalo_data.php?var1="+txt+"&var2="+txt2;
                    }else if ($(this).hasClass('completo_data')) {
                        var txt=$(this).data('table-fechai'); 
                        var txt2=$(this).data('table-fechaf');
                        carga="tables/reportes/reporte_completo_data.php?var1="+txt+"&var2="+txt2;
                    }
                    ...
                    if ($(this).hasClass('table-cumpleanos')) {
                        table =$(this).dataTable({
                        "bPaginate" : true,
                        "destroy":true,
                        "searching": true,
                        ...
                        "aoColumnDefs": [
                            ...
                            { "sWidth": "12%", "className": "text-center", "aTargets": [ 1,2]},
                            { "sWidth": "20%", "className": "text-center", "aTargets": [ 4]},
                            { "sWidth": "10%", "className": "text-center", "aTargets": [ 8]},
                            { "sWidth": "5%", "className": "text-center", "aTargets": [ 3,5,9,6,7]}
                        ],
                        "lengthMenu": [[10, 25, 50, 75, 100,-1],[10,25,50,75,100,"All"]],
                        "pageLength": 10,
                        "dom": "<'row'<'col-xs-6 col-sm-4 col-md-6 tabla-estilo 'l><'col-xs-6 col-sm-5 col-md-5 tabla-estilo'f><'col-xs-6 col-sm-5 col-md-6 tabla-estilo1'B>r>t<'row'<'col-xs-12 col-sm-6 col-md-6 tabla-estilo'i><'spcol-md-6an6'p>>",
                    ...
                    if ($(this).hasClass('table-completo')) {
                        table =$(this).dataTable({
                        "bPaginate" : true,
                        "destroy":true,
                        "searching": true,
                    ...
                    if ($(this).hasClass('table-venta_tickets')) {
                        table =$(this).dataTable({
                        "bPaginate" : true,
                        "destroy":true,
                        "searching": true,
                        ...
                        "aoColumnDefs": [
                            ...
                            { "sWidth": "15%", "className": "text-left", "aTargets": [ 1]},
                            { "sWidth": "5%", "className": "text-center",  "aTargets": [ 2,3,4,5,6,7,8] }
                        ],
                        "lengthMenu": [[10, 25, 50, 75, 100,-1],[10,25,50,75,100,"All"]],
                        "pageLength": 10,
                        "dom": "<'row'<'col-xs-6 col-sm-4 col-md-6 tabla-estilo 'l><'col-xs-6 col-sm-5 col-md-5 tabla-estilo'f><'col-xs-6 col-sm-5 col-md-6 tabla-estilo1'B>r>t<'row'<'col-xs-12 col-sm-6 col-md-6 tabla-estilo'i><'spcol-md-6an6'p>>",
                    ...
                    if ($(this).hasClass('table-venta_sala')) {
                        table =$(this).dataTable({
                        "bPaginate" : true,
                        "destroy":true,
                        "searching": true,
                        ...
                        "aoColumnDefs": [
                            ...
                            { "sWidth": "15%", "className": "text-left", "aTargets": [ 0]},
                    ...
                    if ($(this).hasClass('table-tools1C')) {
                        table =$(this).dataTable({
                        "bPaginate" : true,
                        "destroy":true,
                        "searching": true,
                        ...
                        "aoColumnDefs": [
                            ...
                            { "sWidth": "8%", "className": "text-center", "aTargets": [ 3]},
                            { "sWidth": "6%", "className": "text-center", "aTargets": [ 5,14]},
                            { "sWidth": "4%", "className":  "text-center", "aTargets": [ 1,2,4,6,7,8,11,12,13]  }
                        ],
                        "lengthMenu": [[10, 25, 50, 75, 100,-1],[10,25,50,75,100,"All"]],
                        "pageLength": 10,
                        "dom": "<'row'<'col-xs-6 col-sm-4 col-md-6 tabla-estilo 'l><'col-xs-6 col-sm-5 col-md-5 tabla-estilo'f><'col-xs-6 col-sm-5 col-md-6 tabla-estilo1'B>r>t<'row'<'col-xs-12 col-sm-6 col-md-6 tabla-estilo'i><'spcol-md-6an6'p>>",
                    ...
                    if ($(this).hasClass('table-tools1R')) {
                        ...
                        "aoColumnDefs": [
                            ...
                            { "sWidth": "70px", "className": "text-center", "aTargets": [ 1,2,3,5,6]},
                            { "sWidth": "200px", "className": "text-center", "aTargets": [ 4]},
                            { "sWidth": "80px", "className":  "text-center", "aTargets": [ 8,9,10]  },
                            { "sWidth": "40px", "className": "text-center",  "aTargets": [ 11,12,7] },
                        ],
                        "lengthMenu": [[10, 25, 50, 75, 100,-1],[10,25,50,75,100,"All"]],
                        "pageLength": 10,
                        "dom": "<'row'<'col-xs-6 col-sm-4 col-md-6 tabla-estilo 'l><'col-xs-6 col-sm-5 col-md-5 tabla-estilo'f><'col-xs-6 col-sm-5 col-md-6 tabla-estilo1'B>r>t<'row'<'col-xs-12 col-sm-6 col-md-6 tabla-estilo'i><'spcol-md-6an6'p>>",
                    ...
                    if ($(this).hasClass('table-errorF')) {
                        ...
                        "aoColumnDefs": [
                            ...
                            { "sWidth": "50px", "className": "text-center", "aTargets": [ 6,7,8,9]},
                            { "sWidth": "70px", "className": "text-center", "aTargets": [ 4,5]},
                            { "sWidth": "140px", "className": "text-center", "aTargets": [ 1,2]},
                            { "sWidth": "230px", "className": "text-center", "aTargets": [ 3]}
                        ],
                        "lengthMenu": [[10, 25, 50, 75, 100,-1],[10,25,50,75,100,"All"]],
                        "pageLength": 10,
                        "dom": "<'row'<'col-xs-6 col-sm-4 col-md-6 tabla-estilo 'l><'col-xs-6 col-sm-5 col-md-5 tabla-estilo'f><'col-xs-6 col-sm-5 col-md-6 tabla-estilo1'B>r>t<'row'<'col-xs-12 col-sm-6 col-md-6 tabla-estilo'i><'spcol-md-6an6'p>>",
                    ...
                    if ($(this).hasClass('table-reportesV')) {
                        table =$(this).dataTable({
                            ...
                            "aoColumnDefs": [
                                ...
                                { "sWidth": "130px", "className": "text-center", "aTargets": [ 1,2]},
                                { "sWidth": "200px", "className": "text-center", "aTargets": [ 3]},
                                { "sWidth": "60px", "className": "text-center", "aTargets": [ 4]},
                                { "sWidth": "60px", "className": "text-center", "aTargets": [ 5]},
                                { "sWidth": "40px", "className": "text-center", "aTargets": [ 6,7,11]},
                                { "sWidth": "60px", "className": "text-center", "aTargets": [ 8,9,10,12]}
                            ],
                            "lengthMenu": [[10, 25, 50, 75, 100,-1],[10,25,50,75,100,"All"]],
                            "pageLength": 10,
                            "dom": "<'row'<'col-xs-6 col-sm-4 col-md-6 tabla-estilo 'l><'col-xs-6 col-sm-5 col-md-5 tabla-estilo'f><'col-xs-6 col-sm-5 col-md-6 tabla-estilo1'B>r>t<'row'<'col-xs-12 col-sm-6 col-md-6 tabla-estilo'i><'spcol-md-6an6'p>>",
                    ...
                    if ($(this).hasClass('table-reportesE')) {
                        table =$(this).dataTable({
                            "bPaginate" : true,
                            "destroy":true,
                            "autoWidth": true,
                            ...
                            "aoColumnDefs": [
                                ...
                                { "sWidth": "130px", "className": "text-center", "aTargets": [ 2,4]},
                                { "sWidth": "200px", "className": "text-center", "aTargets": [ 5]},
                                { "sWidth": "60px", "className": "text-center", "aTargets": [ 6,3]},
                                { "sWidth": "60px", "className": "text-center", "aTargets": [ 7]},
                                { "sWidth": "40px", "className": "text-center", "aTargets": [ 8,9,13]},
                                { "sWidth": "60px", "className": "text-center", "aTargets": [ 10,11,12]}
                            ],
                            "lengthMenu": [[10, 25, 50, 75, 100,-1],[10,25,50,75,100,"All"]],
                            "pageLength": 10,
                            "dom": "<'row'<'col-xs-6 col-sm-4 col-md-6 tabla-estilo 'l><'col-xs-6 col-sm-5 col-md-5 tabla-estilo'f><'col-xs-6 col-sm-5 col-md-6 tabla-estilo1'B>r>t<'row'<'col-xs-12 col-sm-6 col-md-6 tabla-estilo'i><'spcol-md-6an6'p>>",
                    ...
                    if ($(this).hasClass('table-reportesN')) {
                        table =$(this).dataTable({
                            "bPaginate" : true,
                            "destroy":true,
                            "autoWidth": true,
                            ...
                            "aoColumnDefs": [
                                ...
                                { "sWidth": "130px", "className": "text-center", "aTargets": [ 2,3,4]},
                                { "sWidth": "200px", "className": "text-center", "aTargets": [ 5]},
                                { "sWidth": "40px", "className": "text-center", "aTargets": [ 9,11,12]},
                                { "sWidth": "60px", "className": "text-center", "aTargets": [ 6,7,8,10]}
                            ],
                            "lengthMenu": [[10, 25, 50, 75, 100,-1],[10,25,50,75,100,"All"]],
                            "pageLength": 10,
                            "dom": "<'row'<'col-xs-6 col-sm-4 col-md-6 tabla-estilo 'l><'col-xs-6 col-sm-5 col-md-5 tabla-estilo'f><'col-xs-6 col-sm-5 col-md-6 tabla-estilo1'B>r>t<'row'<'col-xs-12 col-sm-6 col-md-6 tabla-estilo'i><'spcol-md-6an6'p>>",
