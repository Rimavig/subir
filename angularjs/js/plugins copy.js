                    ...
                    if ($(this).hasClass('table-tools2')) {
                       ...
                       "autoWidth": false,
                        "aoColumnDefs": [
                            ...
                            { "sWidth": "6%", "className": "text-center", "aTargets": 7},
                    ...
                    if ($(this).hasClass('table-tools1')) {
                       ...
                       "autoWidth": false,
                        "aoColumnDefs": [
                            ...
                            { "sWidth": "4%", "className":  "text-center", "aTargets": [ 3,4,6]  },
                        ...
                        table =$(this).dataTable({
                            ...
                            "language": {
                                ...
                                "aoColumnDefs": [
                                    ...
                                    { "sWidth": "30%", "className": "text-center", "aTargets": 2},
                                    { "sWidth": "15%", "className":  "text-center", "aTargets":  4  },
                                    { "sWidth": "30%", "className":  "text-center", "aTargets":  5  },
                                    { "sWidth": "5%", "className":  "text-center", "aTargets":  3  }
                                ],
                    ...
                    if ($(this).hasClass('table-caja')) {
                       ...
                       "autoWidth": false,
                        "aoColumnDefs": [
                            ...
                            { "sWidth": "10%", "className": "text-center", "aTargets": 1},
                            { "sWidth": "5%", "className":  "text-center", "aTargets": [ 7,4]  },
                            { "sWidth": "3%", "className":  "text-center", "aTargets": [ 2,5,6]  },
                            { "sWidth": "6%", "className": "text-center",  "aTargets": [8] },
                            { "sWidth": "7%", "className": "text-center",  "aTargets": [3] }
                        ],
                       "lengthMenu": [[10, 25, 50, 75, 100,-1],[10,25,50,75,100,"All"]],
                       "pageLength": 10,
                       "dom": "<'row'<'col-xs-6 col-sm-4 col-md-6 tabla-estilo 'l><'col-xs-6 col-sm-5 col-md-5 tabla-estilo'f><'col-xs-6 col-sm-5 col-md-6 tabla-estilo1'B>r>t<'row'<'col-xs-12 col-sm-6 col-md-6 tabla-estilo'i><'spcol-md-6an6'p>>",
                    ...
                    if ($(this).hasClass('cortesia')) {
                       ...
                       "autoWidth": false,
                        "aoColumnDefs": [
                            ...
                            { "sWidth": "10%", "className": "text-center", "aTargets": [ 2, 3,5,6,7]},
                            { "sWidth": "5%", "className":  "text-center", "aTargets": [ 4,8] }
                        ],
                       "lengthMenu": [[10, 25, 50, 75, 100,-1],[10,25,50,75,100,"All"]],
                       "pageLength": 10,
                       "dom": "<'row'<'col-xs-6 col-sm-4 col-md-6 tabla-estilo 'l><'col-xs-6 col-sm-5 col-md-5 tabla-estilo'f><'col-xs-6 col-sm-5 col-md-6 tabla-estilo1'B>r>t<'row'<'col-xs-12 col-sm-6 col-md-6 tabla-estilo'i><'spcol-md-6an6'p>>",
