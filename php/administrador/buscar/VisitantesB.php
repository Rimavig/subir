  ...
  <div class="container1" id="container1" >
      <div class="menu_container">
          <label for="ciudadela" class="tableA"><b>Visitantes Recurrentes</b></label>
           <button  class="tableA " onclick="visitantes()"  id="buscar"><span class="icon-search"></span>  Buscar</button>
      </div >
      <div class="buscar table-responsive text-nowrap" >
        ...
        <div class="ventad">
          ...
          <div class="botonA" >
            <button  class="tableB " onclick="usuarios('1')" id="usuarios" ><span class="icon-user-tie"></span>Registro</button>
          </div >
      </div >
      <div class=" cont1" ></div >
      <div class="cont3" >
        ...
        <div class="botonA" >
            <button class="tableB" onclick=" cargar('visitantes')"  id="cargar"><span class="icon-point-up"></span>Aceptar</button>
        </div >
      </div >
  </div >
</span>
