...
$app->group('/v1', function (RouteCollectorProxy $group) {
    ...
    $group->get('/getToken_client', 'App\Controllers\MainController:getToken_client')->add($mw_corp);
    ...
    $group->post('/getTokenFCM', 'App\Controllers\MainController:getTokenFCM')->add($mw_corp);
    $group->post('/updateTokenFCM', 'App\Controllers\MainController:updateTokenFCM')->add($mw_corp);
    $group->post('/isDiners', 'App\Controllers\MainController:isDiners')->add($mw_corp);
    $group->post('/compra_diners_verify', 'App\Controllers\MainController:compra_diners_verify')->add($mw_corp);
    //WEB
    ...
    $group->get('/getCredencial', 'App\Controllers\MainController:getCredencial')->add($mw_corp);
    ...
    $group->post('/callback', 'App\Controllers\MainController:callback');
    $group->post('/login_lector', 'App\Controllers\MainController:login_lector')->add($mw_corp);
    $group->get('/getAllEventos_lector', 'App\Controllers\MainController:getAllEventos_lector')->add($mw_corp);
    $group->post('/getEvento_lector', 'App\Controllers\MainController:getEvento_lector')->add($mw_corp);
    $group->post('/getFuncion_lector', 'App\Controllers\MainController:getFuncion_lector')->add($mw_corp);
    $group->post('/insert_codigo', 'App\Controllers\MainController:insert_codigo')->add($mw_corp);
    $group->post('/registrar_ingreso', 'App\Controllers\MainController:registrar_ingreso')->add($mw_corp);
    $group->post('/registrar_ingreso_gratuito', 'App\Controllers\MainController:registrar_ingreso_gratuito')->add($mw_corp);
    $group->get('/getBannerPrincipal', 'App\Controllers\MainController:getBannerPrincipal')->add($mw_corp);
    $group->post('/getLista_puntos', 'App\Controllers\MainController:getLista_puntos')->add($mw_corp);
    $group->post('/eliminar_usuario', 'App\Controllers\MainController:eliminar_usuario')->add($mw_corp);
    $group->get('/getCafeVino', 'App\Controllers\MainController:getCafeVino')->add($mw_corp);

    header('Access-Control-Allow-Origin:  *');
    header( 'Access-Control-Allow-Headers: Authorization, Content-Type,Canal' );
