                ...
                <div class="col-md-8 col-md-offset-1">
                    <div class="account-wall">
                        <div class="user-image">
                            <img src="../../../assets/global/images/profil_page/friend8.jpg" class="img-responsive img-circle" alt="friend 8">
                            <div id="loader"></div>
                        </div>
                        <form method="post" class="form-signin" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" role="form">
                            <h2>Bienvenido, <strong><?php echo $_SESSION["nombres"]; ?></strong>!</h2>
                        ...
                        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                            ...
                            $re = $client->login($_SESSION["usuario"],$password);
                            $resultado = "";
                            $resultado = "".$re;
                            if ($resultado!="false"){
