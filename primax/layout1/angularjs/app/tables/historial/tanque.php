...
$re = $client->login("Historial Tanques", $tipo.",".$sucursal);
$resultado = "";
$resultado = "".$re;
        ...
        <div class="col-lg-12 portlets">
            <div class="panel">
                <div class="panel-header panel-controls">
                    <h3><i class="fa fa-table"></i> <strong>Historial de tanques</strong></h3>
                </div>
                        ...
                        <table class="table filter-footer table-dynamic table-tools " data-table-name="Historial de tanque">
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td class='hidden-350'> <?php if (isset($datos[5])) {echo $datos[5]; }  ?> Gl </td>
