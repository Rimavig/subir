...
function registrarse() {
	 ...
	 $('.cont1').load('../menu/tipoR.php', {
		 ...
		 contraseña:contraseña,contraseña1:contraseña1,celular:celular,
		 ciudadel:ciudadel
	 });
}
//registro visitante
...
function buscar(tipo) {
		...
		if(tipo=='td:first'){
		  ...
		  $("#tciudadela tbody tr").click(function(event) {
				$(this).addClass('selected').siblings().removeClass('selected');
				value=$(this).find('td:eq(3)').text()+",usuarios";
				$('.cont1').load('../buscar/usuarios.php', {var1:value});
				});
...
function Beditar(tipo) {
	...
	if(tipo=='1'){
		...
		var value3 = nombres.concat(",",apellidos,",",contraseña,",",celular,",",value4);
		...
		var celular=document.getElementById("celular").value;
		var ciudadel=document.getElementById("ciudadel").value;
		var value3 = nombres.concat(",",apellidos,",",email,",",contraseña,",",departamento,",",celular,",",ciudadel);
		console.log(value3);
		document.getElementById("texto").innerHTML = "SE EDITO CORRECTAMENTE";
...
function Bpermisos(tipo) {
	...
	var value4 = document.getElementById("Mingreso").checked;
	var value5 = document.getElementById("Mespecial").checked;
	document.getElementById("texto").innerHTML = "SE REALIZO CORRECTAMENTE";
	if (tipo=='1') {
		$('.cont2').load('../modificar/permisosA.php', {var1:value1,var2:value2,var3:value3,var4:value4,var5:value5});
	}else{
		$('.cont2').load('../modificar/permisos.php', {var1:value1,var2:value2,var3:value3,var4:value4,var5:value5});
	}
