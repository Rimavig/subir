        ...
        <div class="modal-body">
            <form role="form" class=" form-validation">
                    ...
                    if ($tipoPromo==="boletos" ) {
                       ...
                       <div class="row" id="formaPago">
                        ...
                        <div class="row" id="cruzados">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label for="field-1" class="control-label">Cantidad 1</label>
                                    <div class="form-group">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <label for="field-1" class="control-label">Cantidad 2</label>
                                    <div class="form-group">
                ...
                <div class="modal-footer text-center">
                    <button type="submit" class="btn btn-primary btn-embossed bnt-square editar_promocion" ><i class="fa fa-check"></i> Editar</button>
