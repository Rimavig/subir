...
<table class="table" data-table-name="Promoción código promocional" id="table-editable3" >
    ...
    <?php
        ...
        <tr>
            ...
            <td class="text-right">
                <a class="editarPromoCP btn btn-sm btn-dark" style="margin: 5px;"  href="javascript:;"><i class="icon-note"></i></a>
                <a class="deleteCP btn btn-sm btn-danger" style="margin: 5px;"  href="javascript:;"><i class="icons-office-52"></i></a>
                <a class="estadoCP  btn btn-sm btn-blue" style="margin: 5px;"  style="margin: 0px;" href="javascript:;"><i class="icon-key"></i></a>
            </td>
        </tr>
        <?php
            }
