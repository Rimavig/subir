...
angular.module('newApp')
  .controller('promocionesCtrl', ['$scope','pluginsService','$location','$route', function ($scope ,pluginsService, $location,$route) {
    ...
    $scope.editar_general = function (id_promo, id_tipoPromo, tipo) {
        $(this).prop("disabled",true); 
        $('.page-spinner-loader').removeClass('hide');
        var tipo2="";
    ...
    $scope.delete_general = function (id_promo, id_tipoPromo, tipo) {
        $(this).prop("disabled",true); 
        var tipo2="";
        if (tipo=="Factor de Compra/Pago"){
            tipo2="Fpago";
    ...
    $scope.estado_general = function (id_promo, id_tipoPromo, tipo,estado) {
        $(this).prop("disabled",true); 
    ...
    $scope.editar = function (id,nombre) {
        ...
        $('#codigo').load('./tables/procesos/tab_codigo.php', {var1:id},function() { 
            $('.page-spinner-loader').addClass('hide');
            $('.editarEvento').addClass('hide');   
            $('.tabEventos').removeClass('hide');
        });
        $('#compra').load('./tables/procesos/tab_compra.php', {var1:id},function() {    
        });
        $('#pago').load('./tables/procesos/tab_pago.php', {var1:id},function() {    
        });
        $('#tarjeta').load('./tables/procesos/tab_tarjeta.php', {var1:id},function() {    
        });
        $('#cruzados').load('./tables/procesos/tab_cruzados.php', {var1:id},function() {    
        });
        $(this).prop("disabled",false);
    }
        ...
        $(document).on('click', '.crear_promocion_general', function (e) {
            ...
            if(band){
                if (  tipo=="none"){
                    ...
                    if(descuento <= 0){
                        var n = noty({
                            text        : '<div class="alert alert-warning "><p><strong>Ingrese porcentaje de descuento de la promoción</p></div>',
                            layout      : 'topCenter', //or left, right, bottom-right...
                            theme       : 'made',
                            type        : 'error',
                            maxVisible  : 5,
                    ...
                    if(band2){
                        $('.page-spinner-loader').removeClass('hide');
                        $('#alerta').load('./tables/procesos/alerta.php',{id_evento:"1", id_platea:"1",categoria:categoria, nombre:nombre, descripcion:descripcion, fechaI:fechaI,fechaT:fechaT,amigos:amigos,localidadG:localidadG,
                            localidadW:localidadW,localidadA:localidadA,localidadT:localidadT,tipo:tipo, desde:desde, hasta:hasta, descuento:descuento},function() {    
                            $('.page-spinner-loader').addClass('hide');
                        });
                    }else{
                        $(this).prop("disabled",false);
                    ...
                    if(band2){
                        $('.page-spinner-loader').removeClass('hide');
                        $('#alerta').load('./tables/procesos/alerta.php',{id_evento:"1", id_platea:"1",categoria:categoria, nombre:nombre, descripcion:descripcion, fechaI:fechaI,fechaT:fechaT,amigos:amigos,localidadG:localidadG,
                            localidadW:localidadW,localidadA:localidadA,localidadT:localidadT,tipo:tipo, compra:compra, pago:pago},function() {    
                            $('.page-spinner-loader').addClass('hide');
                        });
                    }else{
                        $(this).prop("disabled",false);
                    ...
                    if(band2){
                        $('.page-spinner-loader').removeClass('hide');
                        $('#alerta').load('./tables/procesos/alerta.php',{id_evento:"1", id_platea:"1",categoria:categoria, nombre:nombre, descripcion:descripcion, fechaI:fechaI,fechaT:fechaT,amigos:amigos,localidadG:localidadG,
                            localidadW:localidadW,localidadA:localidadA,localidadT:localidadT,tipo:tipo, tarjeta:tarjeta, banco:banco, descuento:descuento},function() {    
                            $('.page-spinner-loader').addClass('hide');
                        });
                    }else{
                        $(this).prop("disabled",false);
                    ...
                    if(band2){
                        $('.page-spinner-loader').removeClass('hide');
                        $('#alerta').load('./tables/procesos/alerta.php',{id_evento:"1", id_platea:"1",categoria:categoria, nombre:nombre, descripcion:descripcion, fechaI:fechaI,fechaT:fechaT,amigos:amigos,localidadG:localidadG,
                            localidadW:localidadW, localidadA:localidadA, localidadT:localidadT, tipo:tipo, codigo:codigo, descuento:descuento},function() {    
                            $('.page-spinner-loader').addClass('hide');
                        });
                    }else{
                        $(this).prop("disabled",false);
        ...
        $(document).on('click', '.crear_promocion', function (e) {
            ...
            if(band){
                if (  tipo=="none"){
                    ...
                    if(band2){
                        $('.page-spinner-loader').removeClass('hide');
                        $('#alerta').load('./tables/procesos/alerta.php',{promo:"T",id_evento:id, id_platea:platea,categoria:categoria, nombre:nombre, descripcion:descripcion, fechaI:fechaI,fechaT:fechaT,amigos:amigos,localidadG:localidadG,
                            localidadW:localidadW,localidadA:localidadA,localidadT:localidadT,tipo:tipo, desde:desde, hasta:hasta, descuento:descuento},function() {    
                            $('.page-spinner-loader').addClass('hide');
                        });
                    }else{
                    ...
                    if(band2){
                        $('.page-spinner-loader').removeClass('hide');
                        $('#alerta').load('./tables/procesos/alerta.php',{promo:"T",id_evento:id, id_platea:platea,categoria:categoria, nombre:nombre, descripcion:descripcion, fechaI:fechaI,fechaT:fechaT,amigos:amigos,localidadG:localidadG,
                            localidadW:localidadW, localidadA:localidadA, localidadT:localidadT, tipo:tipo, cantidad1:cantidad1, id_evento2:id_evento2, cantidad2:cantidad2},function() {    
                            $('.page-spinner-loader').addClass('hide');
                        });
                    }else{
                        $(this).prop("disabled",false);
        ...
        $(document).on('click', '.editar_promocion_general', function (e) {
            ...
            if(band){
                if (  tipo=="none"){
                    ...
                    if(band2){
                        $('.page-spinner-loader').removeClass('hide');
                        $('#alerta').load('./tables/procesos/alerta.php',{editar:"editar",id_evento:"1", id_platea:"1",idPromocion:idPromocion,idPromocion2:idPromocion2,categoria:categoria, nombre:nombre, descripcion:descripcion, fechaI:fechaI,fechaT:fechaT,amigos:amigos,localidadG:localidadG,
                            localidadW:localidadW,localidadA:localidadA,localidadT:localidadT,tipo:tipo, desde:desde, hasta:hasta, descuento:descuento},function() {    
                            $('.page-spinner-loader').addClass('hide');
                        });
                    }else{
        ...
        $(document).on('click', '.editar_promocion', function (e) {
            ...
            if(band){
                if (  tipo=="none"){
                    ...
                    if(band2){
                        $('.page-spinner-loader').removeClass('hide');
                        $('#alerta').load('./tables/procesos/alerta.php',{editar:"editar",promo:"T",id_evento:id, id_platea:platea,idPromocion:idPromocion,idPromocion2:idPromocion2,categoria:categoria, nombre:nombre, descripcion:descripcion, fechaI:fechaI,fechaT:fechaT,amigos:amigos,localidadG:localidadG,
                            localidadW:localidadW,localidadA:localidadA,localidadT:localidadT,tipo:tipo, desde:desde, hasta:hasta, descuento:descuento},function() {    
                            $('.page-spinner-loader').addClass('hide');
                        });
                    }else{
