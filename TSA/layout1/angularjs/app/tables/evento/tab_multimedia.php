    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="fileinput fileinput-new" data-provides="fileinput">
                ...
                <div class="fileinput-new thumbnail">
                    <img id="imagenC" data-src="" src='<?php  echo $path_imagen.$tipo1."/".$imagenC; ?>?nocache=<?php echo time(); ?>' class="img-responsive" alt="NO IMAGEN">
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="fileinput fileinput-new" data-provides="fileinput">
                ...
                <div class="fileinput-new thumbnail">
                    <img id="imagenV" data-src="" src='<?php  echo $path_imagen.$tipo1."/".$imagenV; ?>?nocache=<?php echo time(); ?>' class="img-responsive" alt="NO IMAGEN">
                </div>
        ...
        <div class="col-md-4">
            ...
            <div class="fileinput fileinput-new" data-provides="fileinput">
                ...
                <div class="fileinput-new thumbnail">
                    <img id="imagenH" data-src="" src='<?php  echo $path_imagen.$tipo1."/".$imagenH; ?>?nocache=<?php echo time(); ?>' class="img-responsive" alt="NO IMAGEN">
                </div>
