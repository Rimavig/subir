                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a class="delete btn btn-sm btn-danger" style="margin: 0px;  " href="javascript:;"><i class="icons-office-52"></i></a>
                                    <a class="estado btn btn-sm btn-warning" style="margin: 0px;" href="javascript:;"><i class="icon-lock"></i></a>
                                    <a class="clave btn btn-sm btn-blue" style="margin: 0px;" href="javascript:;"><i class="icon-key"></i></a>
                                </td>
                            </tr>
                            <?php
                             }
