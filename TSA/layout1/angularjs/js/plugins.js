                ...
                if(lon==1){
                    if ($(this).hasClass('table-tools')) {
                             table =$(this).DataTable({
                                ...
                                "columnDefs": [
                                    ...
                                    { "sWidth": "5%", "className":  "text-center", "aTargets": [ 2,3,5,8]},
                                    { "sWidth": "10%", "className": "text-center", "aTargets": [4]},
                                    { "sWidth": "3%", "className": "text-center",  "aTargets": [6,7] }
                                ],
                    ...
                    if ($(this).hasClass('table-tools1')) {
                        table =$(this).DataTable({
                           ...
                           "ajax": 'usuarios/data-visitante.php',
                           "columnDefs": [
                               {
                                   "targets": [ 0 ],
                                   "className": "hide_column"
                    ...
                    if ($(this).hasClass('table-tools2')) {
                        table =$(this).DataTable({
                           ...
                           "ajax": 'usuarios/data-aprobacion.php',
                           "columnDefs": [
                               {
                                   "targets": [ 0 ],
                                   "className": "hide_column"
                               ...
                               { "sWidth": "10%", "className": "text-center", "aTargets": [ 1]},
                               { "sWidth": "5%", "className":  "text-center", "aTargets": [ 5]},
                               { "sWidth": "10%", "className": "text-center", "aTargets": [4]},
                               { "sWidth": "3%", "className": "text-center",  "aTargets": [2,3,6,7] }
                           ],
                    ...
                    if ($(this).hasClass('table-tools3')) {
                        table =$(this).DataTable({
                           ...
                           "ajax": 'reportes/data-usuarios.php',
                           "columnDefs": [
                            { "sWidth": "10%", "className": "text-center", "aTargets": [ 0,1,4,5,6]},
                            { "sWidth": "5%", "className":  "text-center", "aTargets": [ 2,3]},
                           ],
                    ...
                    if ($(this).hasClass('table-tools4')) {
                        table =$(this).DataTable({
                           ...
                           "ajax": 'reportes/data-visitantes.php',
                           "columnDefs": [
                            { "sWidth": "10%", "className": "text-center", "aTargets": [ 0,2,4,5,6]},
                    ...
                    if ($(this).hasClass('table-tools5')) {
                        table =$(this).DataTable({
                           ...
                           "ajax": 'reportes/data-invitacionN.php',
                           "columnDefs": [
                            { "sWidth": "10%", "className": "text-center", "aTargets": [ 0,2,3,4,5,6]},
                            { "sWidth": "5%", "className":  "text-center", "aTargets": [ 1,7]},
                           ],
                    ...
                    if ($(this).hasClass('table-tools6')) {
                        table =$(this).DataTable({
                           ...
                           "ajax": 'reportes/data-invitacionR.php',
                           "columnDefs": [
                            { "sWidth": "10%", "className": "text-center", "aTargets": [ 0,2,4,5,6,7]},
                            { "sWidth": "5%", "className":  "text-center", "aTargets": [ 1,3,8]},
                           ],
